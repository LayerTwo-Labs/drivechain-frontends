...
import 'package:coinshift/dialogs/command_palette_dialog.dart';
...
import 'package:coinshift/services/code_search_service.dart';
import 'package:coinshift/utils/menu_commands.dart';
import 'package:coinshift/utils/navigation_registry.dart';
import 'package:coinshift/widgets/reset_button.dart';
...
enum Tabs {
  ...
  // coinshift configurable homepage
  CoinShiftHomepage,

  // swaps tab - CoinShift specific
  Swaps,
...
class _HomePageState extends State<HomePage> with WidgetsBindingObserver, WindowListener {
  ...
  CoinShiftRPC get coinshiftRPC => GetIt.I.get<CoinShiftRPC>();
  ...
  List<CommandItem> _getMenuCommands(BuildContext dialogContext) {
    ...
    return [
      ...
      CommandItem(
        ...
        category: 'Your Wallet',
        onSelected: () async {
          await router.push(BackupWalletRoute(appName: 'coinshift'));
        },
      ),
      CommandItem(
        ...
        onSelected: () async {
          await router.push(
            RestoreWalletRoute(
              ...
              binariesToStop: [BitcoinCore(), Enforcer(), CoinShift()],
            ),
          );
        },
      ),
      ...
      CommandItem(
        ...
        category: 'Navigation',
        onSelected: () {
          AutoRouterX(context).tabsRouter.setActiveIndex(Tabs.CoinShiftHomepage.index);
          Navigator.of(dialogContext).pop();
        },
      ),
      CommandItem(
        ...
        category: 'Navigation',
        onSelected: () {
          AutoRouterX(context).tabsRouter.setActiveIndex(Tabs.Swaps.index);
          Navigator.of(dialogContext).pop();
        },
      ),
      CommandItem(
      ...
      CommandItem(
        ...
        category: 'Navigation',
        onSelected: () async {
          await router.push(CoinShiftConfigureHomepageRoute());
        },
      ),
      ...
      // App menu
      CommandItem(
        label: 'Quit CoinShift',
        category: coinshiftRPC.chain.name,
        shortcut: '⌘Q',
  ...
  Widget build(BuildContext context) {
    ...
    return CrossPlatformMenuBar(
      menus: [
        PlatformMenu(
          label: coinshiftRPC.chain.name,
          menus: [
            PlatformMenuItemGroup(
              members: [
                PlatformMenuItem(
                  label: 'About ${coinshiftRPC.chain.name}',
                  onSelected: null,
                ),
              ],
            ),
            PlatformMenuItemGroup(
              members: [
                PlatformMenuItem(
                  label: 'Quit ${coinshiftRPC.chain.name}',
            ...
            PlatformMenuItemGroup(
              members: [
                PlatformMenuItem(
                  ...
                  onSelected: () async {
                    await GetIt.I.get<AppRouter>().push(
                      BackupWalletRoute(appName: 'coinshift'),
                    );
                  },
                ),
                PlatformMenuItem(
      ...
      child: Scaffold(
        ...
        body: auto_router.AutoTabsRouter.builder(
          homeIndex: Tabs.CoinShiftHomepage.index,
          routes: [
            // parent chain routes
            ParentChainRoute(),
            // coinshift configurable homepage
            CoinShiftHomepageRoute(),
            // swaps tab - CoinShift specific
            SwapsTabRoute(),
            // sidechain console route
            ConsoleTabRoute(),
                ...
                return Scaffold(
                  ...
                  appBar: TopNav(
                    routes: [
                      ...
                      TopNavRoute(
                        label: 'Overview',
                        optionalKey: Tabs.CoinShiftHomepage.index,
                        onTap: () {
                          tabsRouter.setActiveIndex(Tabs.CoinShiftHomepage.index);
                        },
                      ),
                      TopNavRoute(
                        label: 'Swaps',
                        optionalKey: Tabs.Swaps.index,
                        onTap: () {
                          tabsRouter.setActiveIndex(Tabs.Swaps.index);
                        },
                      ),
                      TopNavRoute(
                        label: 'Console',
                    ...
                    endWidget: SailRow(
                      ...
                      children: [
                        ...
                        SailButton(
                          ...
                          small: true,
                          onPressed: () async {
                            await GetIt.I.get<AppRouter>().push(CoinShiftConfigureHomepageRoute());
                          },
                        ),
                      ],
                    ),
                    ...
                    children: [
                      ...
                      BottomNav(
                        ...
                        onOpenAdditionalConfConfigurator: () {
                          GetIt.I.get<AppRouter>().push(CoinShiftConfEditorRoute());
                        },
                        endWidgets: const [
                          ResetButton(),
                        ],
