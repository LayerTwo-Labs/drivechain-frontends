...
class _SettingsResetState extends State<SettingsReset> {
    ...
    return SailColumn(
      ...
      children: [
        ...
        ResetOptionTile(
          ...
          title: 'Delete CoinShift Settings',
        ...
        ResetOptionTile(
          ...
          subtitle: 'Deletes all CoinShift data',
          isDestructive: true,
        ),
  ...
  Future<void> _performReset() async {
    ...
    final binary = CoinShift();

    setState(() => _status = 'Stopping CoinShift...');
      ...
      if (_deleteBlockchainData)
        () async {
          try {
            ...
            log.i('Successfully deleted CoinShift blockchain data');
          } catch (e) {
      ...
      if (_deleteSettings)
        () async {
          try {
            ...
            log.i('Successfully deleted CoinShift settings');
          } catch (e) {
      ...
      if (_deleteWalletFiles)
        () async {
          try {
            ...
            log.i('Successfully deleted CoinShift wallet files');
          } catch (e) {
    ...
    setState(() => _status = 'Restarting CoinShift...');
    bootBinaries(log);

    final coinshiftRPC = GetIt.I.get<CoinShiftRPC>();
    while (!coinshiftRPC.connected) {
