...
abstract class RuntimeArgs {
  ...
  static Future<Directory> datadir() async {
    final fromEnv = Platform.environment['COINSHIFT_DATADIR'] ?? const String.fromEnvironment('COINSHIFT_DATADIR');
  ...
  static bool fileLog = Platform.environment['COINSHIFT_LOG_FILE']?.isNotEmpty ?? false;

  static final String _network =
      Platform.environment['COINSHIFT_NETWORK'] ?? const String.fromEnvironment('COINSHIFT_NETWORK');
