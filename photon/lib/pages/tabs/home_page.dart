...
import 'package:photon/dialogs/command_palette_dialog.dart';
...
import 'package:photon/utils/navigation_registry.dart';
import 'package:photon/widgets/reset_button.dart';
  ...
  List<CommandItem> _getMenuCommands(BuildContext dialogContext) {
    ...
    return [
      ...
      CommandItem(
        ...
        category: 'Your Wallet',
        onSelected: () async {
          await router.push(BackupWalletRoute(appName: 'photon'));
        },
      ),
      CommandItem(
      ...
      CommandItem(
        ...
        category: 'Navigation',
        onSelected: () async {
          await router.push(PhotonConfigureHomepageRoute());
        },
      ),
