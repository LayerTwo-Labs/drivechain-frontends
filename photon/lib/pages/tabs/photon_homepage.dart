...
@RoutePage()
class PhotonHomepagePage extends StatelessWidget {
  const PhotonHomepagePage({super.key});

  @override
  Widget build(BuildContext context) {
    return ViewModelBuilder.reactive(
      viewModelBuilder: () => PhotonHomepageViewModel(),
...
class PhotonHomepageViewModel extends BaseViewModel {
  PhotonHomepageProvider get _homepageProvider => GetIt.I.get<PhotonHomepageProvider>();
