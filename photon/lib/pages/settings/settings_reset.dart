...
class _SettingsResetState extends State<SettingsReset> {
    ...
    return SailColumn(
      ...
      children: [
        ...
        ResetOptionTile(
          ...
          subtitle: 'Deletes all Photon data',
          isDestructive: true,
        ),
  ...
  Future<void> _performReset() async {
    ...
    setState(() => _status = 'Stopping Photon...');
    ...
    if (_deleteBlockchainData) {
      ...
      try {
        ...
        log.i('Successfully deleted Photon blockchain data');
      } catch (e) {
    ...
    if (_deleteSettings) {
      ...
      try {
        ...
        log.i('Successfully deleted Photon settings');
      } catch (e) {
    ...
    if (_deleteWalletFiles) {
      ...
      try {
        ...
        log.i('Successfully deleted Photon wallet files');
      } catch (e) {
        log.e('Could not delete wallet files: $e');
      }
    }

    setState(() => _status = 'Restarting Photon...');
    bootBinaries(log);

    final photonRPC = GetIt.I.get<PhotonRPC>();
    while (!photonRPC.connected) {
