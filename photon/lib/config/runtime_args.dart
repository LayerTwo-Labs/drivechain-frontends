...
abstract class RuntimeArgs {
  ...
  static Future<Directory> datadir() async {
    final fromEnv = Platform.environment['PHOTON_DATADIR'] ?? const String.fromEnvironment('PHOTON_DATADIR');
  ...
  static bool consoleLog = Platform.environment['PHOTON_LOG_CONSOLE']?.isNotEmpty ?? false;

  static bool fileLog = Platform.environment['PHOTON_LOG_FILE']?.isNotEmpty ?? false;

  static final String _network =
      Platform.environment['PHOTON_NETWORK'] ?? const String.fromEnvironment('PHOTON_NETWORK');
