...
// Client is a JSON-RPC client for the Thunder sidechain node.
// It mirrors the RPC surface exposed in the Dart ThunderRPC class.
type Client struct {
	baseURL string
	http    *http.Client
}
...
func (e *rpcError) Error() string {
	return fmt.Sprintf("thunder RPC error %d: %s", e.Code, e.Message)
}
