...
type WatchWalletSyncRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	WalletId      string                 `protobuf:"bytes,1,opt,name=wallet_id,json=walletId,proto3" json:"wallet_id,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
...
func (x *WatchWalletSyncRequest) Reset() {
	*x = WatchWalletSyncRequest{}
	mi := &file_walletmanager_v1_walletmanager_proto_msgTypes[58]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *WatchWalletSyncRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*WatchWalletSyncRequest) ProtoMessage() {}

func (x *WatchWalletSyncRequest) ProtoReflect() protoreflect.Message {
	mi := &file_walletmanager_v1_walletmanager_proto_msgTypes[58]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use WatchWalletSyncRequest.ProtoReflect.Descriptor instead.
func (*WatchWalletSyncRequest) Descriptor() ([]byte, []int) {
	return file_walletmanager_v1_walletmanager_proto_rawDescGZIP(), []int{58}
}

func (x *WatchWalletSyncRequest) GetWalletId() string {
	if x != nil {
		return x.WalletId
	}
	return ""
...
// WalletSyncProgress describes what an electrum wallet's scan is doing right now.
type WalletSyncProgress struct {
	state            protoimpl.MessageState `protogen:"open.v1"`
	Scanning         bool                   `protobuf:"varint,1,opt,name=scanning,proto3" json:"scanning,omitempty"` // a scan is in progress
	Phase            string                 `protobuf:"bytes,2,opt,name=phase,proto3" json:"phase,omitempty"`        // idle | scanning | done
	Chain            string                 `protobuf:"bytes,3,opt,name=chain,proto3" json:"chain,omitempty"`        // external | change while scanning
	AddressesScanned int32                  `protobuf:"varint,4,opt,name=addresses_scanned,json=addressesScanned,proto3" json:"addresses_scanned,omitempty"`
	UsedFound        int32                  `protobuf:"varint,5,opt,name=used_found,json=usedFound,proto3" json:"used_found,omitempty"`
	Message          string                 `protobuf:"bytes,6,opt,name=message,proto3" json:"message,omitempty"` // human-readable description
	unknownFields    protoimpl.UnknownFields
	sizeCache        protoimpl.SizeCache
}

func (x *WalletSyncProgress) Reset() {
	*x = WalletSyncProgress{}
	mi := &file_walletmanager_v1_walletmanager_proto_msgTypes[59]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *WalletSyncProgress) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*WalletSyncProgress) ProtoMessage() {}

func (x *WalletSyncProgress) ProtoReflect() protoreflect.Message {
	mi := &file_walletmanager_v1_walletmanager_proto_msgTypes[59]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use WalletSyncProgress.ProtoReflect.Descriptor instead.
func (*WalletSyncProgress) Descriptor() ([]byte, []int) {
	return file_walletmanager_v1_walletmanager_proto_rawDescGZIP(), []int{59}
}

func (x *WalletSyncProgress) GetScanning() bool {
	if x != nil {
		return x.Scanning
	}
	return false
...
func (x *WalletSyncProgress) GetPhase() string {
	if x != nil {
		return x.Phase
	}
	return ""
...
func (x *WalletSyncProgress) GetChain() string {
	if x != nil {
		return x.Chain
	}
	return ""
...
func (x *WalletSyncProgress) GetAddressesScanned() int32 {
	if x != nil {
		return x.AddressesScanned
	}
	return 0
}

func (x *WalletSyncProgress) GetUsedFound() int32 {
	if x != nil {
		return x.UsedFound
	}
	return 0
...
func (x *WalletSyncProgress) GetMessage() string {
	if x != nil {
		return x.Message
	}
	return ""
...
const file_walletmanager_v1_walletmanager_proto_rawDesc = "" +
	...
	"\n" +
	"raw_tx_hex\x18\x01 \x01(\tR\brawTxHex\"5\n" +
	"\x16WatchWalletSyncRequest\x12\x1b\n" +
	"\twallet_id\x18\x01 \x01(\tR\bwalletId\"\xc2\x01\n" +
	"\x12WalletSyncProgress\x12\x1a\n" +
	"\bscanning\x18\x01 \x01(\bR\bscanning\x12\x14\n" +
	"\x05phase\x18\x02 \x01(\tR\x05phase\x12\x14\n" +
	"\x05chain\x18\x03 \x01(\tR\x05chain\x12+\n" +
	"\x11addresses_scanned\x18\x04 \x01(\x05R\x10addressesScanned\x12\x1d\n" +
	"\n" +
	"used_found\x18\x05 \x01(\x05R\tusedFound\x12\x18\n" +
	...
	"'RESTORE_WALLET_BACKUP_STEP_STATE_FAILED\x10\x032\xb9 \n" +
	...
	"\fFinalizePsbt\x12%.walletmanager.v1.FinalizePsbtRequest\x1a&.walletmanager.v1.FinalizePsbtResponse\x12c\n" +
	"\x0fWatchWalletSync\x12(.walletmanager.v1.WatchWalletSyncRequest\x1a$.walletmanager.v1.WalletSyncProgress0\x01\x12`\n" +
...
var file_walletmanager_v1_walletmanager_proto_goTypes = []any{
	...
	(*WatchWalletSyncRequest)(nil),              // 60: walletmanager.v1.WatchWalletSyncRequest
	(*WalletSyncProgress)(nil),                  // 61: walletmanager.v1.WalletSyncProgress
...
var file_walletmanager_v1_walletmanager_proto_depIdxs = []int32{
	...
	94, // 14: walletmanager.v1.CreatePsbtRequest.destinations:type_name -> walletmanager.v1.CreatePsbtRequest.DestinationsEntry
	66, // 15: walletmanager.v1.CreatePsbtRequest.required_inputs:type_name -> walletmanager.v1.UnspentOutput
	63, // 16: walletmanager.v1.ListTransactionsResponse.transactions:type_name -> walletmanager.v1.TransactionEntry
	96, // 17: walletmanager.v1.UnspentOutput.received_at:type_name -> google.protobuf.Timestamp
	66, // 18: walletmanager.v1.ListUnspentResponse.utxos:type_name -> walletmanager.v1.UnspentOutput
	69, // 19: walletmanager.v1.ListReceiveAddressesResponse.addresses:type_name -> walletmanager.v1.ReceiveAddress
	63, // 20: walletmanager.v1.GetTransactionDetailsResponse.transaction:type_name -> walletmanager.v1.TransactionEntry
	73, // 21: walletmanager.v1.GetTransactionDetailsResponse.inputs:type_name -> walletmanager.v1.TransactionInput
	74, // 22: walletmanager.v1.GetTransactionDetailsResponse.outputs:type_name -> walletmanager.v1.TransactionOutput
	82, // 23: walletmanager.v1.ListCoreVariantsResponse.variants:type_name -> walletmanager.v1.CoreVariant
	...
	62, // 47: walletmanager.v1.WalletManagerService.ListTransactions:input_type -> walletmanager.v1.ListTransactionsRequest
	65, // 48: walletmanager.v1.WalletManagerService.ListUnspent:input_type -> walletmanager.v1.ListUnspentRequest
	68, // 49: walletmanager.v1.WalletManagerService.ListReceiveAddresses:input_type -> walletmanager.v1.ListReceiveAddressesRequest
	71, // 50: walletmanager.v1.WalletManagerService.GetTransactionDetails:input_type -> walletmanager.v1.GetTransactionDetailsRequest
	75, // 51: walletmanager.v1.WalletManagerService.BumpFee:input_type -> walletmanager.v1.BumpFeeRequest
	77, // 52: walletmanager.v1.WalletManagerService.DeriveAddresses:input_type -> walletmanager.v1.DeriveAddressesRequest
	...
	60, // 57: walletmanager.v1.WalletManagerService.WatchWalletSync:input_type -> walletmanager.v1.WatchWalletSyncRequest
	79, // 58: walletmanager.v1.WalletManagerService.GetWalletSeed:input_type -> walletmanager.v1.GetWalletSeedRequest
	81, // 59: walletmanager.v1.WalletManagerService.ListCoreVariants:input_type -> walletmanager.v1.ListCoreVariantsRequest
	84, // 60: walletmanager.v1.WalletManagerService.GetCoreVariant:input_type -> walletmanager.v1.GetCoreVariantRequest
	86, // 61: walletmanager.v1.WalletManagerService.SetCoreVariant:input_type -> walletmanager.v1.SetCoreVariantRequest
	88, // 62: walletmanager.v1.WalletManagerService.GetTestSidechains:input_type -> walletmanager.v1.GetTestSidechainsRequest
	90, // 63: walletmanager.v1.WalletManagerService.SetTestSidechains:input_type -> walletmanager.v1.SetTestSidechainsRequest
	97, // 64: walletmanager.v1.WalletManagerService.WatchWalletData:input_type -> google.protobuf.Empty
	3,  // 65: walletmanager.v1.WalletManagerService.GetWalletStatus:output_type -> walletmanager.v1.GetWalletStatusResponse
	5,  // 66: walletmanager.v1.WalletManagerService.GenerateWallet:output_type -> walletmanager.v1.GenerateWalletResponse
	7,  // 67: walletmanager.v1.WalletManagerService.UnlockWallet:output_type -> walletmanager.v1.UnlockWalletResponse
	9,  // 68: walletmanager.v1.WalletManagerService.LockWallet:output_type -> walletmanager.v1.LockWalletResponse
	11, // 69: walletmanager.v1.WalletManagerService.EncryptWallet:output_type -> walletmanager.v1.EncryptWalletResponse
	13, // 70: walletmanager.v1.WalletManagerService.ChangePassword:output_type -> walletmanager.v1.ChangePasswordResponse
	15, // 71: walletmanager.v1.WalletManagerService.RemoveEncryption:output_type -> walletmanager.v1.RemoveEncryptionResponse
	19, // 72: walletmanager.v1.WalletManagerService.ListWallets:output_type -> walletmanager.v1.ListWalletsResponse
	21, // 73: walletmanager.v1.WalletManagerService.SwitchWallet:output_type -> walletmanager.v1.SwitchWalletResponse
	23, // 74: walletmanager.v1.WalletManagerService.UpdateWalletMetadata:output_type -> walletmanager.v1.UpdateWalletMetadataResponse
	25, // 75: walletmanager.v1.WalletManagerService.DeleteWallet:output_type -> walletmanager.v1.DeleteWalletResponse
	27, // 76: walletmanager.v1.WalletManagerService.DeleteAllWallets:output_type -> walletmanager.v1.DeleteAllWalletsResponse
	32, // 77: walletmanager.v1.WalletManagerService.ListWalletBackups:output_type -> walletmanager.v1.ListWalletBackupsResponse
	34, // 78: walletmanager.v1.WalletManagerService.RestoreWalletBackup:output_type -> walletmanager.v1.RestoreWalletBackupResponse
	37, // 79: walletmanager.v1.WalletManagerService.RestoreWalletBackupStream:output_type -> walletmanager.v1.RestoreWalletBackupProgressResponse
	39, // 80: walletmanager.v1.WalletManagerService.CreateWatchOnlyWallet:output_type -> walletmanager.v1.CreateWatchOnlyWalletResponse
	41, // 81: walletmanager.v1.WalletManagerService.CreateElectrumWallet:output_type -> walletmanager.v1.CreateElectrumWalletResponse
	43, // 82: walletmanager.v1.WalletManagerService.CreateBitcoinCoreWallet:output_type -> walletmanager.v1.CreateBitcoinCoreWalletResponse
	45, // 83: walletmanager.v1.WalletManagerService.EnsureCoreWallets:output_type -> walletmanager.v1.EnsureCoreWalletsResponse
	47, // 84: walletmanager.v1.WalletManagerService.GetBalance:output_type -> walletmanager.v1.GetBalanceResponse
	49, // 85: walletmanager.v1.WalletManagerService.GetNewAddress:output_type -> walletmanager.v1.GetNewAddressResponse
	51, // 86: walletmanager.v1.WalletManagerService.SendTransaction:output_type -> walletmanager.v1.SendTransactionResponse
	64, // 87: walletmanager.v1.WalletManagerService.ListTransactions:output_type -> walletmanager.v1.ListTransactionsResponse
	67, // 88: walletmanager.v1.WalletManagerService.ListUnspent:output_type -> walletmanager.v1.ListUnspentResponse
	70, // 89: walletmanager.v1.WalletManagerService.ListReceiveAddresses:output_type -> walletmanager.v1.ListReceiveAddressesResponse
	72, // 90: walletmanager.v1.WalletManagerService.GetTransactionDetails:output_type -> walletmanager.v1.GetTransactionDetailsResponse
	76, // 91: walletmanager.v1.WalletManagerService.BumpFee:output_type -> walletmanager.v1.BumpFeeResponse
	78, // 92: walletmanager.v1.WalletManagerService.DeriveAddresses:output_type -> walletmanager.v1.DeriveAddressesResponse
	53, // 93: walletmanager.v1.WalletManagerService.CreatePsbt:output_type -> walletmanager.v1.CreatePsbtResponse
	55, // 94: walletmanager.v1.WalletManagerService.SignPsbt:output_type -> walletmanager.v1.SignPsbtResponse
	57, // 95: walletmanager.v1.WalletManagerService.CombinePsbt:output_type -> walletmanager.v1.CombinePsbtResponse
	59, // 96: walletmanager.v1.WalletManagerService.FinalizePsbt:output_type -> walletmanager.v1.FinalizePsbtResponse
	61, // 97: walletmanager.v1.WalletManagerService.WatchWalletSync:output_type -> walletmanager.v1.WalletSyncProgress
	80, // 98: walletmanager.v1.WalletManagerService.GetWalletSeed:output_type -> walletmanager.v1.GetWalletSeedResponse
	83, // 99: walletmanager.v1.WalletManagerService.ListCoreVariants:output_type -> walletmanager.v1.ListCoreVariantsResponse
	85, // 100: walletmanager.v1.WalletManagerService.GetCoreVariant:output_type -> walletmanager.v1.GetCoreVariantResponse
	87, // 101: walletmanager.v1.WalletManagerService.SetCoreVariant:output_type -> walletmanager.v1.SetCoreVariantResponse
	89, // 102: walletmanager.v1.WalletManagerService.GetTestSidechains:output_type -> walletmanager.v1.GetTestSidechainsResponse
	91, // 103: walletmanager.v1.WalletManagerService.SetTestSidechains:output_type -> walletmanager.v1.SetTestSidechainsResponse
	92, // 104: walletmanager.v1.WalletManagerService.WatchWalletData:output_type -> walletmanager.v1.WatchWalletDataResponse
