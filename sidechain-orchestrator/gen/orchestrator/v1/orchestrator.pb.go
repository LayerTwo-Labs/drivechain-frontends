...
const file_orchestrator_v1_orchestrator_proto_rawDesc = "" +
	...
	"\x16DELETION_TYPE_SOFTWARE\x10\x052\xe5\x13\n" +
	...
	"\x11ApplyUTXOSnapshot\x12).orchestrator.v1.ApplyUTXOSnapshotRequest\x1a*.orchestrator.v1.ApplyUTXOSnapshotResponse0\x01\x12Z\n" +
...
var file_orchestrator_v1_orchestrator_proto_msgTypes = make([]protoimpl.MessageInfo, 61)
var file_orchestrator_v1_orchestrator_proto_goTypes = []any{
	...
	(*ShutdownAllRequest)(nil),                 // 27: orchestrator.v1.ShutdownAllRequest
	(*ShutdownAllResponse)(nil),                // 28: orchestrator.v1.ShutdownAllResponse
	(*GetBTCPriceRequest)(nil),                 // 29: orchestrator.v1.GetBTCPriceRequest
	(*GetBTCPriceResponse)(nil),                // 30: orchestrator.v1.GetBTCPriceResponse
	(*GetMainchainBlockchainInfoRequest)(nil),  // 31: orchestrator.v1.GetMainchainBlockchainInfoRequest
	(*GetMainchainBlockchainInfoResponse)(nil), // 32: orchestrator.v1.GetMainchainBlockchainInfoResponse
	(*GetEnforcerBlockchainInfoRequest)(nil),   // 33: orchestrator.v1.GetEnforcerBlockchainInfoRequest
	(*GetEnforcerBlockchainInfoResponse)(nil),  // 34: orchestrator.v1.GetEnforcerBlockchainInfoResponse
	(*GetSyncStatusRequest)(nil),               // 35: orchestrator.v1.GetSyncStatusRequest
	(*GetSyncStatusResponse)(nil),              // 36: orchestrator.v1.GetSyncStatusResponse
	(*SidechainStatus)(nil),                    // 37: orchestrator.v1.SidechainStatus
	(*ChainSync)(nil),                          // 38: orchestrator.v1.ChainSync
	(*GetDownloadStatusRequest)(nil),           // 39: orchestrator.v1.GetDownloadStatusRequest
	(*GetDownloadStatusResponse)(nil),          // 40: orchestrator.v1.GetDownloadStatusResponse
	(*DownloadStatus)(nil),                     // 41: orchestrator.v1.DownloadStatus
	(*GetMainchainBalanceRequest)(nil),         // 42: orchestrator.v1.GetMainchainBalanceRequest
	(*GetMainchainBalanceResponse)(nil),        // 43: orchestrator.v1.GetMainchainBalanceResponse
	(*GetSidechainBalanceRequest)(nil),         // 44: orchestrator.v1.GetSidechainBalanceRequest
	(*GetSidechainBalanceResponse)(nil),        // 45: orchestrator.v1.GetSidechainBalanceResponse
	(*SingleDeletion)(nil),                     // 46: orchestrator.v1.SingleDeletion
	(*GatherFilesToDeleteRequest)(nil),         // 47: orchestrator.v1.GatherFilesToDeleteRequest
	(*GatherFilesToDeleteResponse)(nil),        // 48: orchestrator.v1.GatherFilesToDeleteResponse
	(*ResetFileInfo)(nil),                      // 49: orchestrator.v1.ResetFileInfo
	(*DeleteFilesRequest)(nil),                 // 50: orchestrator.v1.DeleteFilesRequest
	(*DeleteFilesResponse)(nil),                // 51: orchestrator.v1.DeleteFilesResponse
	(*GetCoreMempoolInfoRequest)(nil),          // 52: orchestrator.v1.GetCoreMempoolInfoRequest
	(*GetCoreMempoolInfoResponse)(nil),         // 53: orchestrator.v1.GetCoreMempoolInfoResponse
	(*CoreRawCallRequest)(nil),                 // 54: orchestrator.v1.CoreRawCallRequest
	(*CoreRawCallResponse)(nil),                // 55: orchestrator.v1.CoreRawCallResponse
	(*GetForkStatusRequest)(nil),               // 56: orchestrator.v1.GetForkStatusRequest
	(*GetForkStatusResponse)(nil),              // 57: orchestrator.v1.GetForkStatusResponse
	(*ForkWalletClaim)(nil),                    // 58: orchestrator.v1.ForkWalletClaim
	(*ForkClaimUtxo)(nil),                      // 59: orchestrator.v1.ForkClaimUtxo
	(*ShutdownRequest)(nil),                    // 60: orchestrator.v1.ShutdownRequest
	(*ShutdownResponse)(nil),                   // 61: orchestrator.v1.ShutdownResponse
	nil,                                        // 62: orchestrator.v1.StartBinaryRequest.EnvEntry
	nil,                                        // 63: orchestrator.v1.StartWithL1Request.TargetEnvEntry
}
var file_orchestrator_v1_orchestrator_proto_depIdxs = []int32{
	...
	62, // 3: orchestrator.v1.StartBinaryRequest.env:type_name -> orchestrator.v1.StartBinaryRequest.EnvEntry
	63, // 4: orchestrator.v1.StartWithL1Request.target_env:type_name -> orchestrator.v1.StartWithL1Request.TargetEnvEntry
	38, // 5: orchestrator.v1.GetSyncStatusResponse.mainchain:type_name -> orchestrator.v1.ChainSync
	38, // 6: orchestrator.v1.GetSyncStatusResponse.enforcer:type_name -> orchestrator.v1.ChainSync
	37, // 7: orchestrator.v1.GetSyncStatusResponse.sidechains:type_name -> orchestrator.v1.SidechainStatus
	0,  // 8: orchestrator.v1.SidechainStatus.type:type_name -> orchestrator.v1.SidechainType
	38, // 9: orchestrator.v1.SidechainStatus.sync:type_name -> orchestrator.v1.ChainSync
	41, // 10: orchestrator.v1.GetDownloadStatusResponse.downloads:type_name -> orchestrator.v1.DownloadStatus
	...
	46, // 15: orchestrator.v1.GatherFilesToDeleteRequest.items:type_name -> orchestrator.v1.SingleDeletion
	49, // 16: orchestrator.v1.GatherFilesToDeleteResponse.files:type_name -> orchestrator.v1.ResetFileInfo
	...
	46, // 19: orchestrator.v1.DeleteFilesRequest.items:type_name -> orchestrator.v1.SingleDeletion
	58, // 20: orchestrator.v1.GetForkStatusResponse.claims:type_name -> orchestrator.v1.ForkWalletClaim
	59, // 21: orchestrator.v1.ForkWalletClaim.utxos:type_name -> orchestrator.v1.ForkClaimUtxo
	...
	27, // 33: orchestrator.v1.OrchestratorService.ShutdownAll:input_type -> orchestrator.v1.ShutdownAllRequest
	60, // 34: orchestrator.v1.OrchestratorService.Shutdown:input_type -> orchestrator.v1.ShutdownRequest
	29, // 35: orchestrator.v1.OrchestratorService.GetBTCPrice:input_type -> orchestrator.v1.GetBTCPriceRequest
	31, // 36: orchestrator.v1.OrchestratorService.GetMainchainBlockchainInfo:input_type -> orchestrator.v1.GetMainchainBlockchainInfoRequest
	33, // 37: orchestrator.v1.OrchestratorService.GetEnforcerBlockchainInfo:input_type -> orchestrator.v1.GetEnforcerBlockchainInfoRequest
	35, // 38: orchestrator.v1.OrchestratorService.GetSyncStatus:input_type -> orchestrator.v1.GetSyncStatusRequest
	39, // 39: orchestrator.v1.OrchestratorService.GetDownloadStatus:input_type -> orchestrator.v1.GetDownloadStatusRequest
	42, // 40: orchestrator.v1.OrchestratorService.GetMainchainBalance:input_type -> orchestrator.v1.GetMainchainBalanceRequest
	44, // 41: orchestrator.v1.OrchestratorService.GetSidechainBalance:input_type -> orchestrator.v1.GetSidechainBalanceRequest
	47, // 42: orchestrator.v1.OrchestratorService.GatherFilesToDelete:input_type -> orchestrator.v1.GatherFilesToDeleteRequest
	50, // 43: orchestrator.v1.OrchestratorService.DeleteFiles:input_type -> orchestrator.v1.DeleteFilesRequest
	52, // 44: orchestrator.v1.OrchestratorService.GetCoreMempoolInfo:input_type -> orchestrator.v1.GetCoreMempoolInfoRequest
	54, // 45: orchestrator.v1.OrchestratorService.CoreRawCall:input_type -> orchestrator.v1.CoreRawCallRequest
	56, // 46: orchestrator.v1.OrchestratorService.GetForkStatus:input_type -> orchestrator.v1.GetForkStatusRequest
	6,  // 47: orchestrator.v1.OrchestratorService.ListBinaries:output_type -> orchestrator.v1.ListBinariesResponse
	8,  // 48: orchestrator.v1.OrchestratorService.GetBinaryStatus:output_type -> orchestrator.v1.GetBinaryStatusResponse
	10, // 49: orchestrator.v1.OrchestratorService.GetBinaryVersion:output_type -> orchestrator.v1.GetBinaryVersionResponse
	12, // 50: orchestrator.v1.OrchestratorService.DownloadBinary:output_type -> orchestrator.v1.DownloadBinaryResponse
	14, // 51: orchestrator.v1.OrchestratorService.StartBinary:output_type -> orchestrator.v1.StartBinaryResponse
	16, // 52: orchestrator.v1.OrchestratorService.StopBinary:output_type -> orchestrator.v1.StopBinaryResponse
	18, // 53: orchestrator.v1.OrchestratorService.StreamLogs:output_type -> orchestrator.v1.StreamLogsResponse
	20, // 54: orchestrator.v1.OrchestratorService.StartWithL1:output_type -> orchestrator.v1.StartWithL1Response
	22, // 55: orchestrator.v1.OrchestratorService.RestartDaemon:output_type -> orchestrator.v1.RestartDaemonResponse
	24, // 56: orchestrator.v1.OrchestratorService.RestartL1:output_type -> orchestrator.v1.RestartL1Response
	26, // 57: orchestrator.v1.OrchestratorService.ApplyUTXOSnapshot:output_type -> orchestrator.v1.ApplyUTXOSnapshotResponse
	28, // 58: orchestrator.v1.OrchestratorService.ShutdownAll:output_type -> orchestrator.v1.ShutdownAllResponse
	61, // 59: orchestrator.v1.OrchestratorService.Shutdown:output_type -> orchestrator.v1.ShutdownResponse
	30, // 60: orchestrator.v1.OrchestratorService.GetBTCPrice:output_type -> orchestrator.v1.GetBTCPriceResponse
	32, // 61: orchestrator.v1.OrchestratorService.GetMainchainBlockchainInfo:output_type -> orchestrator.v1.GetMainchainBlockchainInfoResponse
	34, // 62: orchestrator.v1.OrchestratorService.GetEnforcerBlockchainInfo:output_type -> orchestrator.v1.GetEnforcerBlockchainInfoResponse
	36, // 63: orchestrator.v1.OrchestratorService.GetSyncStatus:output_type -> orchestrator.v1.GetSyncStatusResponse
	40, // 64: orchestrator.v1.OrchestratorService.GetDownloadStatus:output_type -> orchestrator.v1.GetDownloadStatusResponse
	43, // 65: orchestrator.v1.OrchestratorService.GetMainchainBalance:output_type -> orchestrator.v1.GetMainchainBalanceResponse
	45, // 66: orchestrator.v1.OrchestratorService.GetSidechainBalance:output_type -> orchestrator.v1.GetSidechainBalanceResponse
	48, // 67: orchestrator.v1.OrchestratorService.GatherFilesToDelete:output_type -> orchestrator.v1.GatherFilesToDeleteResponse
	51, // 68: orchestrator.v1.OrchestratorService.DeleteFiles:output_type -> orchestrator.v1.DeleteFilesResponse
	53, // 69: orchestrator.v1.OrchestratorService.GetCoreMempoolInfo:output_type -> orchestrator.v1.GetCoreMempoolInfoResponse
	55, // 70: orchestrator.v1.OrchestratorService.CoreRawCall:output_type -> orchestrator.v1.CoreRawCallResponse
	57, // 71: orchestrator.v1.OrchestratorService.GetForkStatus:output_type -> orchestrator.v1.GetForkStatusResponse
