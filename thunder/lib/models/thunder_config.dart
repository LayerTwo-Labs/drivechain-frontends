/// Configuration model for the Thunder sidechain.
...
class ThunderConfig {
  ...
  ThunderConfig.fromConfig(ThunderConfig other) {
  ...
  String serialize() {
    ...
    buffer.writeln('# Thunder Configuration - Generated by Thunder App');
    buffer.writeln('# These settings are converted to CLI arguments when Thunder starts.');
    buffer.writeln();
  ...
  bool operator ==(Object other) {
    ...
    if (other is! ThunderConfig) return false;
