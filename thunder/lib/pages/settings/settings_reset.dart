...
class _SettingsResetState extends State<SettingsReset> {
    ...
    return SailColumn(
      ...
      children: [
        ...
        ResetOptionTile(
          ...
          subtitle: 'Deletes all Thunder data',
          isDestructive: true,
        ),
  ...
  Future<void> _performReset() async {
    ...
    setState(() => _status = 'Stopping Thunder...');
    ...
    if (_deleteBlockchainData) {
      ...
      try {
        ...
        log.i('Successfully deleted Thunder blockchain data');
      } catch (e) {
    ...
    if (_deleteSettings) {
      ...
      try {
        ...
        log.i('Successfully deleted Thunder settings');
      } catch (e) {
    ...
    setState(() => _status = 'Restarting Thunder...');
    bootBinaries(log);
