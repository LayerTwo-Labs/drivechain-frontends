...
import 'package:bbc/main.dart' show bootBinaries;
import 'package:bbc/pages/tabs/home_page.dart';
import 'package:bbc/pages/tabs/settings_page.dart';
import 'package:bbc/pages/tabs/bbc_configure_homepage_page.dart';
import 'package:bbc/pages/tabs/bbc_homepage.dart';
import 'package:bbc/pages/bbc_conf_editor_page.dart';
...
class AppRouter extends RootStackRouter {
  ...
  List<AutoRoute> get routes => [
    ...
    AutoRoute(
      page: BbcConfigureHomepageRoute.page,
    ),
    AutoRoute(
