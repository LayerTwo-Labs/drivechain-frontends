...
class BbcHomepageConfigurationSetting extends SettingValue<HomepageConfiguration> {
  @override
  String get key => 'bbc_homepage_configuration';

  BbcHomepageConfigurationSetting({super.newValue});

  @override
  HomepageConfiguration defaultValue() => BbcHomepageConfiguration.defaultConfiguration;
  ...
  SettingValue<HomepageConfiguration> withValue([HomepageConfiguration? value]) {
    return BbcHomepageConfigurationSetting(newValue: value);
  }
}

class BbcHomepageConfiguration {
...
class BbcHomepageProvider extends HomepageProvider {
  final ClientSettings _settings = GetIt.I.get<ClientSettings>();

  @override
  HomepageConfiguration configuration = BbcHomepageConfiguration.defaultConfiguration;
  @override
  HomepageConfiguration tempConfiguration = BbcHomepageConfiguration.defaultConfiguration;
  @override
  ...
  Future<void> saveConfiguration() async {
    ...
    try {
      final setting = BbcHomepageConfigurationSetting(newValue: tempConfiguration);
