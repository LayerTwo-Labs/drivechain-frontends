...
/// Provider for Bbc configuration settings.
/// In backend mode, uses BackendSidechainConfProvider (RPC-backed).
/// In frontend mode, uses the file-based implementation directly.
class BbcConfProvider extends GenericSidechainConfProvider {
  BbcConfProvider._create();

  static Future<GenericSidechainConfProvider> create() async {
    final source = BbcConfProvider._create();
    return BackendSidechainConfProvider.fromProvider(source, sidechainName: 'bbc');
  }

  @override
  String get appName => 'Big Block Covenant';

  @override
  String get configFileName => 'bbc.conf';

  @override
  String getDataDir() => Bbc().datadir();
  ...
  String getDefaultConfig() {
    ...
    return '''# Bbc Configuration - Generated by Bbc App
# These settings are converted to CLI arguments when Bbc starts.
