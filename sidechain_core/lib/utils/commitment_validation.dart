...
String? validateCommitment({
  ...
  final hasAddress =
      (website != null && website.isNotEmpty) || (ipv4 != null && ipv4.isNotEmpty) || (ipv6 != null && ipv6.isNotEmpty);
  if (!hasAddress) {
    return 'Set a website. A commitment with no address is a hash nobody can read.';
  }
