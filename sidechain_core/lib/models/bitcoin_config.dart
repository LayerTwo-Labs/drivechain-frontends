...
const String kBitcoinConfVersionCommentPrefix = '# bitwindow-bitcoin-conf-version=';

class BitcoinConfig {
  Map<String, String> globalSettings = {};
  // Network sections - only valid Bitcoin Core sections
  // Note: forknet and eCash use 'main' section since they run on mainnet params
  ...
  String serialize() {
    ...
    if (configVersion > 0) {
      buffer.writeln('$kBitcoinConfVersionCommentPrefix$configVersion');
      buffer.writeln();
    }
    // Add header comment
    buffer.writeln('# Generated by BitWindow Bitcoin Configuration Editor');
    buffer.writeln('# Feel free to edit this file, changes will be applied.');
    buffer.writeln();
  ...
  int get hashCode {
    ...
    return result ^ configVersion.hashCode;
  }
}
