...
class EnforcerConfigOptions {
  static const List<EnforcerConfigOption> allOptions = [
    ...
    EnforcerConfigOption(
      key: 'enable-block-template-server',
      category: 'General',
      description: 'Enable Block Template Server',
      tooltip: 'Serve getblocktemplate to miners. Needs the mempool.',
    ...
    EnforcerConfigOption(
      ...
      tooltip: 'If enabled, keeps a mempool. The block template server needs it.',
      inputType: EnforcerConfigInputType.boolean,
      isUseful: true,
      defaultValue: true,
    ),
    ...
    EnforcerConfigOption(
      ...
      tooltip:
          'URL of the Esplora server to use for the wallet. Network defaults: Signet: https://explorer.signet.drivechain.info/api, Mainnet: https://esplora.mainnet.drivechain.info, eCash: whatever the published network catalog lists. Regtest has no default — the enforcer runs with wallet-sync-source=disabled instead.',
