...
abstract class PhotonServiceBase extends $pb.GeneratedService {
  ...
  $async.Future<$11.ForgetPeerResponse> forgetPeer($pb.ServerContext ctx, $11.ForgetPeerRequest request);
  ...
  $async.Future<$pb.GeneratedMessage> handleCall(
    ...
    switch (methodName) {
      ...
      case 'ForgetPeer':
        return this.forgetPeer(ctx, request as $11.ForgetPeerRequest);
      case 'ListPeers':
