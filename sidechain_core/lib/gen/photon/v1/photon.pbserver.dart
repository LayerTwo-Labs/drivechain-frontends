...
abstract class PhotonServiceBase extends $pb.GeneratedService {
  ...
  $async.Future<$13.ForgetPeerResponse> forgetPeer($pb.ServerContext ctx, $13.ForgetPeerRequest request);
  ...
  $async.Future<$13.GetWalletAddressesResponse> getWalletAddresses($pb.ServerContext ctx, $13.GetWalletAddressesRequest request);
  ...
  $pb.GeneratedMessage createRequest($core.String methodName) {
    switch (methodName) {
      ...
      case 'ForgetPeer': return $13.ForgetPeerRequest();
      ...
      case 'GetWalletAddresses': return $13.GetWalletAddressesRequest();
  ...
  $async.Future<$pb.GeneratedMessage> handleCall($pb.ServerContext ctx, $core.String methodName, $pb.GeneratedMessage request) {
    switch (methodName) {
      ...
      case 'ForgetPeer': return this.forgetPeer(ctx, request as $13.ForgetPeerRequest);
      ...
      case 'GetWalletAddresses': return this.getWalletAddresses(ctx, request as $13.GetWalletAddressesRequest);
      default: throw $core.ArgumentError('Unknown method: $methodName');
    }
  }
