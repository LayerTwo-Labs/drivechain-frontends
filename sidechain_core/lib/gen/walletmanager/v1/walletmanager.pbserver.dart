...
abstract class WalletManagerServiceBase extends $pb.GeneratedService {
  ...
  $async.Future<$19.CancelTransactionResponse> cancelTransaction($pb.ServerContext ctx, $19.CancelTransactionRequest request);
  ...
  $pb.GeneratedMessage createRequest($core.String methodName) {
    switch (methodName) {
      ...
      case 'CancelTransaction': return $19.CancelTransactionRequest();
  ...
  $async.Future<$pb.GeneratedMessage> handleCall($pb.ServerContext ctx, $core.String methodName, $pb.GeneratedMessage request) {
    switch (methodName) {
      ...
      case 'CancelTransaction': return this.cancelTransaction(ctx, request as $19.CancelTransactionRequest);
