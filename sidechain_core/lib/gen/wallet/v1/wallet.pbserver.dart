...
abstract class WalletServiceBase extends $pb.GeneratedService {
  ...
  $async.Future<$13.ListSidechainDepositsResponse> listSidechainDeposits($pb.ServerContext ctx, $13.ListSidechainDepositsRequest request);
  $async.Future<$13.CreateSidechainDepositResponse> createSidechainDeposit($pb.ServerContext ctx, $13.CreateSidechainDepositRequest request);
  ...
  $async.Future<$13.GetChequePrivateKeyResponse> getChequePrivateKey($pb.ServerContext ctx, $13.GetChequePrivateKeyRequest request);
  $async.Future<$13.ListChequesResponse> listCheques($pb.ServerContext ctx, $13.ListChequesRequest request);
  $async.Future<$13.CheckChequeFundingResponse> checkChequeFunding($pb.ServerContext ctx, $13.CheckChequeFundingRequest request);
  $async.Future<$13.PreviewSweepResponse> previewSweep($pb.ServerContext ctx, $13.PreviewSweepRequest request);
  ...
  $async.Future<$13.GetUTXODistributionResponse> getUTXODistribution($pb.ServerContext ctx, $13.GetUTXODistributionRequest request);
  ...
  $pb.GeneratedMessage createRequest($core.String methodName) {
    switch (methodName) {
      ...
      case 'ListSidechainDeposits': return $13.ListSidechainDepositsRequest();
      case 'CreateSidechainDeposit': return $13.CreateSidechainDepositRequest();
      case 'SignMessage': return $13.SignMessageRequest();
      case 'VerifyMessage': return $13.VerifyMessageRequest();
      case 'GetStats': return $13.GetStatsRequest();
      case 'UnlockWallet': return $13.UnlockWalletRequest();
      case 'LockWallet': return $1.Empty();
      case 'IsWalletUnlocked': return $1.Empty();
      case 'CreateCheque': return $13.CreateChequeRequest();
      case 'GetCheque': return $13.GetChequeRequest();
      case 'GetChequePrivateKey': return $13.GetChequePrivateKeyRequest();
      case 'ListCheques': return $13.ListChequesRequest();
      case 'CheckChequeFunding': return $13.CheckChequeFundingRequest();
      case 'PreviewSweep': return $13.PreviewSweepRequest();
      case 'SweepCheque': return $13.SweepChequeRequest();
      case 'DeleteCheque': return $13.DeleteChequeRequest();
      case 'SetUTXOMetadata': return $13.SetUTXOMetadataRequest();
      case 'GetUTXOMetadata': return $13.GetUTXOMetadataRequest();
      case 'SetCoinSelectionStrategy': return $13.SetCoinSelectionStrategyRequest();
      case 'GetCoinSelectionStrategy': return $1.Empty();
      case 'GetTransactionDetails': return $13.GetTransactionDetailsRequest();
      case 'GetUTXODistribution': return $13.GetUTXODistributionRequest();
      case 'BumpFee': return $13.BumpFeeRequest();
      case 'SelectCoins': return $13.SelectCoinsRequest();
      case 'CreateBackup': return $1.Empty();
      case 'RestoreBackup': return $13.RestoreBackupRequest();
      case 'ValidateBackup': return $13.ValidateBackupRequest();
  ...
  $async.Future<$pb.GeneratedMessage> handleCall($pb.ServerContext ctx, $core.String methodName, $pb.GeneratedMessage request) {
    switch (methodName) {
      ...
      case 'ListSidechainDeposits': return this.listSidechainDeposits(ctx, request as $13.ListSidechainDepositsRequest);
      case 'CreateSidechainDeposit': return this.createSidechainDeposit(ctx, request as $13.CreateSidechainDepositRequest);
      case 'SignMessage': return this.signMessage(ctx, request as $13.SignMessageRequest);
      case 'VerifyMessage': return this.verifyMessage(ctx, request as $13.VerifyMessageRequest);
      case 'GetStats': return this.getStats(ctx, request as $13.GetStatsRequest);
      ...
      case 'CreateCheque': return this.createCheque(ctx, request as $13.CreateChequeRequest);
      case 'GetCheque': return this.getCheque(ctx, request as $13.GetChequeRequest);
      case 'GetChequePrivateKey': return this.getChequePrivateKey(ctx, request as $13.GetChequePrivateKeyRequest);
      case 'ListCheques': return this.listCheques(ctx, request as $13.ListChequesRequest);
      case 'CheckChequeFunding': return this.checkChequeFunding(ctx, request as $13.CheckChequeFundingRequest);
      case 'PreviewSweep': return this.previewSweep(ctx, request as $13.PreviewSweepRequest);
      case 'SweepCheque': return this.sweepCheque(ctx, request as $13.SweepChequeRequest);
      case 'DeleteCheque': return this.deleteCheque(ctx, request as $13.DeleteChequeRequest);
      case 'SetUTXOMetadata': return this.setUTXOMetadata(ctx, request as $13.SetUTXOMetadataRequest);
      case 'GetUTXOMetadata': return this.getUTXOMetadata(ctx, request as $13.GetUTXOMetadataRequest);
      case 'SetCoinSelectionStrategy': return this.setCoinSelectionStrategy(ctx, request as $13.SetCoinSelectionStrategyRequest);
      ...
      case 'GetUTXODistribution': return this.getUTXODistribution(ctx, request as $13.GetUTXODistributionRequest);
      case 'BumpFee': return this.bumpFee(ctx, request as $13.BumpFeeRequest);
      case 'SelectCoins': return this.selectCoins(ctx, request as $13.SelectCoinsRequest);
      case 'CreateBackup': return this.createBackup(ctx, request as $1.Empty);
      case 'RestoreBackup': return this.restoreBackup(ctx, request as $13.RestoreBackupRequest);
      case 'ValidateBackup': return this.validateBackup(ctx, request as $13.ValidateBackupRequest);
      default: throw $core.ArgumentError('Unknown method: $methodName');
    }
  }
