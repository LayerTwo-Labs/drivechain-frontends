...
class SweepAddressKind extends $pb.ProtobufEnum {
  static const SweepAddressKind SWEEP_ADDRESS_KIND_UNSPECIFIED = SweepAddressKind._(0, _omitEnumNames ? '' : 'SWEEP_ADDRESS_KIND_UNSPECIFIED');
  static const SweepAddressKind SWEEP_ADDRESS_KIND_P2WPKH = SweepAddressKind._(1, _omitEnumNames ? '' : 'SWEEP_ADDRESS_KIND_P2WPKH');
  static const SweepAddressKind SWEEP_ADDRESS_KIND_P2PKH = SweepAddressKind._(2, _omitEnumNames ? '' : 'SWEEP_ADDRESS_KIND_P2PKH');
