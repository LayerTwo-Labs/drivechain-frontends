...
abstract class SidechainServiceBase extends $pb.GeneratedService {
  ...
  $async.Future<$7.SubmitTransactionResponse> submitTransaction(
      $pb.ServerContext ctx, $7.SubmitTransactionRequest request);
  $async.Future<$7.SubscribeEventsResponse> subscribeEvents($pb.ServerContext ctx, $7.SubscribeEventsRequest request);

  $pb.GeneratedMessage createRequest($core.String methodName) {
    switch (methodName) {
      case 'GetMempoolTxs':
        return $7.GetMempoolTxsRequest();
      case 'GetUtxos':
        return $7.GetUtxosRequest();
      case 'SubmitTransaction':
        return $7.SubmitTransactionRequest();
      case 'SubscribeEvents':
        return $7.SubscribeEventsRequest();
      default:
  ...
  $async.Future<$pb.GeneratedMessage> handleCall(
    ...
    switch (methodName) {
      case 'GetMempoolTxs':
        return this.getMempoolTxs(ctx, request as $7.GetMempoolTxsRequest);
      case 'GetUtxos':
        return this.getUtxos(ctx, request as $7.GetUtxosRequest);
      case 'SubmitTransaction':
        return this.submitTransaction(ctx, request as $7.SubmitTransactionRequest);
      case 'SubscribeEvents':
        return this.subscribeEvents(ctx, request as $7.SubscribeEventsRequest);
      default:
        throw $core.ArgumentError('Unknown method: $methodName');
    }
  }
