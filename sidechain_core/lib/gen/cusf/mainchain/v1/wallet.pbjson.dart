...
const WalletTransaction$json = {
  ...
  '2': [
    ...
    {'1': 'sent_sats', '3': 4, '4': 1, '5': 4, '10': 'sentSats'},
    {
      ...
      '4': 1,
      '5': 11,
      '6': '.cusf.mainchain.v1.WalletTransaction.Confirmation',
      '10': 'confirmationInfo'
    },
  ],
...
final $typed_data.Uint8List walletTransactionDescriptor =
    $convert.base64Decode('ChFXYWxsZXRUcmFuc2FjdGlvbhIuCgR0eGlkGAEgASgLMhouY3VzZi5jb21tb24udjEuUmV2ZX'
...
final $typed_data.Uint8List broadcastWithdrawalBundleRequestDescriptor =
    $convert.base64Decode('CiBCcm9hZGNhc3RXaXRoZHJhd2FsQnVuZGxlUmVxdWVzdBI/CgxzaWRlY2hhaW5faWQYASABKA'
...
final $typed_data.Uint8List broadcastWithdrawalBundleResponseDescriptor =
    $convert.base64Decode('CiFCcm9hZGNhc3RXaXRoZHJhd2FsQnVuZGxlUmVzcG9uc2U=');
...
final $typed_data.Uint8List createBmmCriticalDataTransactionRequestDescriptor =
    $convert.base64Decode('CidDcmVhdGVCbW1Dcml0aWNhbERhdGFUcmFuc2FjdGlvblJlcXVlc3QSPwoMc2lkZWNoYWluX2'
...
final $typed_data.Uint8List createBmmCriticalDataTransactionResponseDescriptor =
    $convert.base64Decode('CihDcmVhdGVCbW1Dcml0aWNhbERhdGFUcmFuc2FjdGlvblJlc3BvbnNlEi4KBHR4aWQYASABKA'
...
final $typed_data.Uint8List createDepositTransactionRequestDescriptor =
    $convert.base64Decode('Ch9DcmVhdGVEZXBvc2l0VHJhbnNhY3Rpb25SZXF1ZXN0Ej8KDHNpZGVjaGFpbl9pZBgBIAEoCz'
...
final $typed_data.Uint8List createDepositTransactionResponseDescriptor =
    $convert.base64Decode('CiBDcmVhdGVEZXBvc2l0VHJhbnNhY3Rpb25SZXNwb25zZRIuCgR0eGlkGAEgASgLMhouY3VzZi'
...
final $typed_data.Uint8List createNewAddressRequestDescriptor =
    $convert.base64Decode('ChdDcmVhdGVOZXdBZGRyZXNzUmVxdWVzdA==');
...
final $typed_data.Uint8List createNewAddressResponseDescriptor =
    $convert.base64Decode('ChhDcmVhdGVOZXdBZGRyZXNzUmVzcG9uc2USGAoHYWRkcmVzcxgBIAEoCVIHYWRkcmVzcw==');
...
final $typed_data.Uint8List createSidechainProposalRequestDescriptor =
    $convert.base64Decode('Ch5DcmVhdGVTaWRlY2hhaW5Qcm9wb3NhbFJlcXVlc3QSPwoMc2lkZWNoYWluX2lkGAEgASgLMh'
  ...
  '2': [
    {
      ...
      '4': 1,
      '5': 11,
      '6': '.cusf.mainchain.v1.CreateSidechainProposalResponse.Confirmed',
      '9': 0,
      '10': 'confirmed'
    },
    {
      ...
      '4': 1,
      '5': 11,
      '6': '.cusf.mainchain.v1.CreateSidechainProposalResponse.NotConfirmed',
      '9': 0,
      '10': 'notConfirmed'
    },
  ],
...
final $typed_data.Uint8List createSidechainProposalResponseDescriptor =
    $convert.base64Decode('Ch9DcmVhdGVTaWRlY2hhaW5Qcm9wb3NhbFJlc3BvbnNlElwKCWNvbmZpcm1lZBgBIAEoCzI8Lm'
...
final $typed_data.Uint8List submitSidechainProposalRequestDescriptor =
    $convert.base64Decode('Ch5TdWJtaXRTaWRlY2hhaW5Qcm9wb3NhbFJlcXVlc3QSPwoMc2lkZWNoYWluX2lkGAEgASgLMh'
        'wuZ29vZ2xlLnByb3RvYnVmLlVJbnQzMlZhbHVlUgtzaWRlY2hhaW5JZBJJCgtkZWNsYXJhdGlv'
        'bhgCIAEoCzInLmN1c2YubWFpbmNoYWluLnYxLlNpZGVjaGFpbkRlY2xhcmF0aW9uUgtkZWNsYX'
        'JhdGlvbg==');
...
final $typed_data.Uint8List submitSidechainProposalResponseDescriptor =
    $convert.base64Decode('Ch9TdWJtaXRTaWRlY2hhaW5Qcm9wb3NhbFJlc3BvbnNl');
...
final $typed_data.Uint8List createWalletRequestDescriptor =
    $convert.base64Decode('ChNDcmVhdGVXYWxsZXRSZXF1ZXN0EiUKDm1uZW1vbmljX3dvcmRzGAEgAygJUg1tbmVtb25pY1'
...
final $typed_data.Uint8List getBalanceResponseDescriptor =
    $convert.base64Decode('ChJHZXRCYWxhbmNlUmVzcG9uc2USJQoOY29uZmlybWVkX3NhdHMYASABKARSDWNvbmZpcm1lZF'
...
final $typed_data.Uint8List listSidechainDepositTransactionsRequestDescriptor =
    $convert.base64Decode('CidMaXN0U2lkZWNoYWluRGVwb3NpdFRyYW5zYWN0aW9uc1JlcXVlc3Q=');
  ...
  '2': [
    {
      ...
      '4': 3,
      '5': 11,
      '6': '.cusf.mainchain.v1.ListSidechainDepositTransactionsResponse.SidechainDepositTransaction',
      '10': 'transactions'
    },
  ],
...
final $typed_data.Uint8List listSidechainDepositTransactionsResponseDescriptor =
    $convert.base64Decode('CihMaXN0U2lkZWNoYWluRGVwb3NpdFRyYW5zYWN0aW9uc1Jlc3BvbnNlEnsKDHRyYW5zYWN0aW'
...
final $typed_data.Uint8List listTransactionsRequestDescriptor =
    $convert.base64Decode('ChdMaXN0VHJhbnNhY3Rpb25zUmVxdWVzdA==');
...
final $typed_data.Uint8List listTransactionsResponseDescriptor =
    $convert.base64Decode('ChhMaXN0VHJhbnNhY3Rpb25zUmVzcG9uc2USSAoMdHJhbnNhY3Rpb25zGAEgAygLMiQuY3VzZi'
  ...
  '2': [
    {
      ...
      '4': 3,
      '5': 11,
      '6': '.cusf.mainchain.v1.SendTransactionRequest.DestinationsEntry',
      '10': 'destinations'
    },
    {
      '1': 'fee_rate',
      ...
      '4': 1,
      '5': 11,
      '6': '.cusf.mainchain.v1.SendTransactionRequest.FeeRate',
      '9': 0,
      '10': 'feeRate',
      '17': true
    },
    ...
    },
    {
      ...
      '4': 3,
      '5': 11,
      '6': '.cusf.mainchain.v1.SendTransactionRequest.RequiredUtxo',
      '10': 'requiredUtxos'
    },
    {'1': 'drain_wallet_to', '3': 5, '4': 1, '5': 9, '9': 2, '10': 'drainWalletTo', '17': true},
  ],
  '3': [
    SendTransactionRequest_FeeRate$json,
    SendTransactionRequest_RequiredUtxo$json,
    SendTransactionRequest_DestinationsEntry$json
  ],
  '8': [
    {'1': '_fee_rate'},
...
final $typed_data.Uint8List sendTransactionRequestDescriptor =
    $convert.base64Decode('ChZTZW5kVHJhbnNhY3Rpb25SZXF1ZXN0El8KDGRlc3RpbmF0aW9ucxgBIAMoCzI7LmN1c2YubW'
...
final $typed_data.Uint8List sendTransactionResponseDescriptor =
    $convert.base64Decode('ChdTZW5kVHJhbnNhY3Rpb25SZXNwb25zZRIuCgR0eGlkGAEgASgLMhouY3VzZi5jb21tb24udj'
...
final $typed_data.Uint8List generateBlocksRequestDescriptor =
    $convert.base64Decode('ChVHZW5lcmF0ZUJsb2Nrc1JlcXVlc3QSNAoGYmxvY2tzGAEgASgLMhwuZ29vZ2xlLnByb3RvYn'
...
final $typed_data.Uint8List generateBlocksResponseDescriptor =
    $convert.base64Decode('ChZHZW5lcmF0ZUJsb2Nrc1Jlc3BvbnNlEjkKCmJsb2NrX2hhc2gYASABKAsyGi5jdXNmLmNvbW'
...
const GetInfoResponse$json = {
  ...
  '2': [
    ...
    {'1': 'unspent_output_count', '3': 3, '4': 1, '5': 13, '10': 'unspentOutputCount'},
    {
      ...
      '4': 3,
      '5': 11,
      '6': '.cusf.mainchain.v1.GetInfoResponse.DescriptorsEntry',
      '10': 'descriptors'
    },
...
final $typed_data.Uint8List getInfoResponseDescriptor =
    $convert.base64Decode('Cg9HZXRJbmZvUmVzcG9uc2USGAoHbmV0d29yaxgBIAEoCVIHbmV0d29yaxIrChF0cmFuc2FjdG'
...
final $typed_data.Uint8List listUnspentOutputsRequestDescriptor =
    $convert.base64Decode('ChlMaXN0VW5zcGVudE91dHB1dHNSZXF1ZXN0');
  ...
  '2': [
    {
      ...
      '4': 3,
      '5': 11,
      '6': '.cusf.mainchain.v1.ListUnspentOutputsResponse.Output',
      '10': 'outputs'
    },
  ],
...
const ListUnspentOutputsResponse_Output$json = {
  ...
  '2': [
    ...
    {
      '1': 'confirmed_transitively',
      '3': 8,
      '4': 1,
      '5': 11,
      '6': '.cusf.common.v1.ReverseHex',
      '10': 'confirmedTransitively'
    },
    {
      '1': 'unconfirmed_last_seen',
      '3': 9,
      '4': 1,
      '5': 11,
      '6': '.google.protobuf.Timestamp',
      '10': 'unconfirmedLastSeen'
    },
...
final $typed_data.Uint8List listUnspentOutputsResponseDescriptor =
    $convert.base64Decode('ChpMaXN0VW5zcGVudE91dHB1dHNSZXNwb25zZRJOCgdvdXRwdXRzGAEgAygLMjQuY3VzZi5tYW'
...
const $core.Map<$core.String, $core.dynamic> WalletServiceBase$json = {
  ...
  '2': [
    {
      '1': 'BroadcastWithdrawalBundle',
      '2': '.cusf.mainchain.v1.BroadcastWithdrawalBundleRequest',
      '3': '.cusf.mainchain.v1.BroadcastWithdrawalBundleResponse',
      '4': {'34': 2},
    },
    {
      '1': 'CreateBmmCriticalDataTransaction',
      '2': '.cusf.mainchain.v1.CreateBmmCriticalDataTransactionRequest',
      '3': '.cusf.mainchain.v1.CreateBmmCriticalDataTransactionResponse'
    },
    {
      '1': 'CreateDepositTransaction',
      '2': '.cusf.mainchain.v1.CreateDepositTransactionRequest',
      '3': '.cusf.mainchain.v1.CreateDepositTransactionResponse'
    },
    {
      '1': 'CreateNewAddress',
      '2': '.cusf.mainchain.v1.CreateNewAddressRequest',
      '3': '.cusf.mainchain.v1.CreateNewAddressResponse'
    },
    {
      '1': 'CreateSidechainProposal',
      '2': '.cusf.mainchain.v1.CreateSidechainProposalRequest',
      '3': '.cusf.mainchain.v1.CreateSidechainProposalResponse',
      '6': true
    },
    {
      '1': 'SubmitSidechainProposal',
      '2': '.cusf.mainchain.v1.SubmitSidechainProposalRequest',
      '3': '.cusf.mainchain.v1.SubmitSidechainProposalResponse'
    },
    {
      '1': 'CreateWallet',
      '2': '.cusf.mainchain.v1.CreateWalletRequest',
      '3': '.cusf.mainchain.v1.CreateWalletResponse'
    },
    {
      '1': 'GetBalance',
      '2': '.cusf.mainchain.v1.GetBalanceRequest',
      '3': '.cusf.mainchain.v1.GetBalanceResponse',
      '4': {'34': 1},
    },
    {
      '1': 'ListSidechainDepositTransactions',
      '2': '.cusf.mainchain.v1.ListSidechainDepositTransactionsRequest',
      '3': '.cusf.mainchain.v1.ListSidechainDepositTransactionsResponse',
      '4': {'34': 1},
    },
    {
      '1': 'ListTransactions',
      '2': '.cusf.mainchain.v1.ListTransactionsRequest',
      '3': '.cusf.mainchain.v1.ListTransactionsResponse',
      '4': {'34': 1},
    },
    {
      '1': 'ListUnspentOutputs',
      '2': '.cusf.mainchain.v1.ListUnspentOutputsRequest',
      '3': '.cusf.mainchain.v1.ListUnspentOutputsResponse',
      '4': {'34': 1},
    },
    {
      '1': 'GetInfo',
      '2': '.cusf.mainchain.v1.GetInfoRequest',
      '3': '.cusf.mainchain.v1.GetInfoResponse',
      '4': {'34': 1},
    },
    {
      '1': 'SendTransaction',
      '2': '.cusf.mainchain.v1.SendTransactionRequest',
      '3': '.cusf.mainchain.v1.SendTransactionResponse'
    },
    {
      '1': 'UnlockWallet',
      '2': '.cusf.mainchain.v1.UnlockWalletRequest',
      '3': '.cusf.mainchain.v1.UnlockWalletResponse',
      '4': {'34': 2},
    },
    {
      '1': 'GenerateBlocks',
      '2': '.cusf.mainchain.v1.GenerateBlocksRequest',
      '3': '.cusf.mainchain.v1.GenerateBlocksResponse',
      '6': true
    },
  ],
};
...
const $core.Map<$core.String, $core.Map<$core.String, $core.dynamic>> WalletServiceBase$messageJson = {
  ...
  '.cusf.mainchain.v1.ListSidechainDepositTransactionsResponse.SidechainDepositTransaction':
      ListSidechainDepositTransactionsResponse_SidechainDepositTransaction$json,
...
final $typed_data.Uint8List walletServiceDescriptor =
    $convert.base64Decode('Cg1XYWxsZXRTZXJ2aWNlEosBChlCcm9hZGNhc3RXaXRoZHJhd2FsQnVuZGxlEjMuY3VzZi5tYW'
        'luY2hhaW4udjEuQnJvYWRjYXN0V2l0aGRyYXdhbEJ1bmRsZVJlcXVlc3QaNC5jdXNmLm1haW5j'
        'aGFpbi52MS5Ccm9hZGNhc3RXaXRoZHJhd2FsQnVuZGxlUmVzcG9uc2UiA5ACAhKbAQogQ3JlYX'
        'RlQm1tQ3JpdGljYWxEYXRhVHJhbnNhY3Rpb24SOi5jdXNmLm1haW5jaGFpbi52MS5DcmVhdGVC'
        'bW1Dcml0aWNhbERhdGFUcmFuc2FjdGlvblJlcXVlc3QaOy5jdXNmLm1haW5jaGFpbi52MS5Dcm'
        'VhdGVCbW1Dcml0aWNhbERhdGFUcmFuc2FjdGlvblJlc3BvbnNlEoMBChhDcmVhdGVEZXBvc2l0'
        'VHJhbnNhY3Rpb24SMi5jdXNmLm1haW5jaGFpbi52MS5DcmVhdGVEZXBvc2l0VHJhbnNhY3Rpb2'
        '5SZXF1ZXN0GjMuY3VzZi5tYWluY2hhaW4udjEuQ3JlYXRlRGVwb3NpdFRyYW5zYWN0aW9uUmVz'
        'cG9uc2USawoQQ3JlYXRlTmV3QWRkcmVzcxIqLmN1c2YubWFpbmNoYWluLnYxLkNyZWF0ZU5ld0'
