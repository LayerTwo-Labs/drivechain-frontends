...
class ListNetworksRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ListNetworksRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'orchestrator.v1'), createEmptyInstance: create)
    ..hasRequiredFields = false
  ;
...
class NetworkOption extends $pb.GeneratedMessage {
  ...
  factory NetworkOption.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory NetworkOption.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'NetworkOption', package: const $pb.PackageName(_omitMessageNames ? '' : 'orchestrator.v1'), createEmptyInstance: create)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  NetworkOption copyWith(void Function(NetworkOption) updates) => super.copyWith((message) => updates(message as NetworkOption)) as NetworkOption;
  ...
  @$pb.TagNumber(4)
  set isCurrent($core.bool v) { $_setBool(3, v); }
  @$pb.TagNumber(4)
...
class ListNetworksResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ListNetworksResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'orchestrator.v1'), createEmptyInstance: create)
...
class PlanECashSwitchRequest extends $pb.GeneratedMessage {
  ...
  factory PlanECashSwitchRequest.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory PlanECashSwitchRequest.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'PlanECashSwitchRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'orchestrator.v1'), createEmptyInstance: create)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  PlanECashSwitchRequest copyWith(void Function(PlanECashSwitchRequest) updates) => super.copyWith((message) => updates(message as PlanECashSwitchRequest)) as PlanECashSwitchRequest;
  ...
  @$core.pragma('dart2js:noInline')
  static PlanECashSwitchRequest getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<PlanECashSwitchRequest>(create);
...
class PlanECashSwitchResponse extends $pb.GeneratedMessage {
  ...
  factory PlanECashSwitchResponse.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory PlanECashSwitchResponse.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'PlanECashSwitchResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'orchestrator.v1'), createEmptyInstance: create)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  PlanECashSwitchResponse copyWith(void Function(PlanECashSwitchResponse) updates) => super.copyWith((message) => updates(message as PlanECashSwitchResponse)) as PlanECashSwitchResponse;
  ...
  @$core.pragma('dart2js:noInline')
  static PlanECashSwitchResponse getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<PlanECashSwitchResponse>(create);
  ...
  @$pb.TagNumber(3)
  set rewindHeight($core.int v) { $_setUnsignedInt32(2, v); }
  @$pb.TagNumber(3)
  ...
  @$pb.TagNumber(4)
  set needsRollback($core.bool v) { $_setBool(3, v); }
  @$pb.TagNumber(4)
...
class TakeNewNetworksRequest extends $pb.GeneratedMessage {
  ...
  factory TakeNewNetworksRequest.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory TakeNewNetworksRequest.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'TakeNewNetworksRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'orchestrator.v1'), createEmptyInstance: create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  TakeNewNetworksRequest copyWith(void Function(TakeNewNetworksRequest) updates) => super.copyWith((message) => updates(message as TakeNewNetworksRequest)) as TakeNewNetworksRequest;
  ...
  @$core.pragma('dart2js:noInline')
  static TakeNewNetworksRequest getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<TakeNewNetworksRequest>(create);
...
class TakeNewNetworksResponse extends $pb.GeneratedMessage {
  ...
  factory TakeNewNetworksResponse.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory TakeNewNetworksResponse.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'TakeNewNetworksResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'orchestrator.v1'), createEmptyInstance: create)
    ..pc<NetworkOption>(1, _omitFieldNames ? '' : 'networks', $pb.PbFieldType.PM, subBuilder: NetworkOption.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  TakeNewNetworksResponse copyWith(void Function(TakeNewNetworksResponse) updates) => super.copyWith((message) => updates(message as TakeNewNetworksResponse)) as TakeNewNetworksResponse;
  ...
  @$core.pragma('dart2js:noInline')
  static TakeNewNetworksResponse getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<TakeNewNetworksResponse>(create);
...
class BitcoinConfServiceApi {
  ...
  $async.Future<TakeNewNetworksResponse> takeNewNetworks($pb.ClientContext? ctx, TakeNewNetworksRequest request) =>
    _client.invoke<TakeNewNetworksResponse>(ctx, 'BitcoinConfService', 'TakeNewNetworks', request, TakeNewNetworksResponse())
  ;
  $async.Future<PlanECashSwitchResponse> planECashSwitch($pb.ClientContext? ctx, PlanECashSwitchRequest request) =>
    _client.invoke<PlanECashSwitchResponse>(ctx, 'BitcoinConfService', 'PlanECashSwitch', request, PlanECashSwitchResponse())
  ;
