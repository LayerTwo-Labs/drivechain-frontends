...
final $typed_data.Uint8List networkOptionDescriptor = $convert.base64Decode(
    'Cg1OZXR3b3JrT3B0aW9uEg4KAmlkGAEgASgJUgJpZBIhCgxkaXNwbGF5X25hbWUYAiABKAlSC2'
...
final $typed_data.Uint8List listNetworksResponseDescriptor = $convert.base64Decode(
    'ChRMaXN0TmV0d29ya3NSZXNwb25zZRI6CghuZXR3b3JrcxgBIAMoCzIeLm9yY2hlc3RyYXRvci'
...
final $typed_data.Uint8List planECashSwitchRequestDescriptor = $convert.base64Decode(
    'ChZQbGFuRUNhc2hTd2l0Y2hSZXF1ZXN0Eh0KCm5ldHdvcmtfaWQYASABKAlSCW5ldHdvcmtJZA'
    '==');
...
const PlanECashSwitchResponse$json = {
  ...
  '2': [
    ...
    {'1': 'has_chain_data', '3': 6, '4': 1, '5': 8, '10': 'hasChainData'},
    {'1': 'chain_id', '3': 7, '4': 1, '5': 9, '10': 'chainId'},
  ],
};

/// Descriptor for `PlanECashSwitchResponse`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List planECashSwitchResponseDescriptor = $convert.base64Decode(
    'ChdQbGFuRUNhc2hTd2l0Y2hSZXNwb25zZRIXCgdmcm9tX2lkGAEgASgJUgZmcm9tSWQSEwoFdG'
    ...
    'Jsb2NrZWQSJAoOaGFzX2NoYWluX2RhdGEYBiABKAhSDGhhc0NoYWluRGF0YRIZCghjaGFpbl9p'
    'ZBgHIAEoCVIHY2hhaW5JZA==');
...
final $typed_data.Uint8List takeNewNetworksRequestDescriptor = $convert.base64Decode(
    'ChZUYWtlTmV3TmV0d29ya3NSZXF1ZXN0');
...
final $typed_data.Uint8List takeNewNetworksResponseDescriptor = $convert.base64Decode(
    'ChdUYWtlTmV3TmV0d29ya3NSZXNwb25zZRI6CghuZXR3b3JrcxgBIAMoCzIeLm9yY2hlc3RyYX'
...
const $core.Map<$core.String, $core.dynamic> BitcoinConfServiceBase$json = {
  ...
  '2': [
    ...
    {'1': 'TakeNewNetworks', '2': '.orchestrator.v1.TakeNewNetworksRequest', '3': '.orchestrator.v1.TakeNewNetworksResponse'},
    {'1': 'PlanECashSwitch', '2': '.orchestrator.v1.PlanECashSwitchRequest', '3': '.orchestrator.v1.PlanECashSwitchResponse'},
