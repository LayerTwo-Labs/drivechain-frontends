...
abstract class OrchestratorServiceBase extends $pb.GeneratedService {
  ...
  $async.Future<$2.WipeUntilBlockResponse> wipeUntilBlock($pb.ServerContext ctx, $2.WipeUntilBlockRequest request);
  ...
  $pb.GeneratedMessage createRequest($core.String methodName) {
    switch (methodName) {
      ...
      case 'WipeUntilBlock': return $2.WipeUntilBlockRequest();
  ...
  $async.Future<$pb.GeneratedMessage> handleCall($pb.ServerContext ctx, $core.String methodName, $pb.GeneratedMessage request) {
    switch (methodName) {
      ...
      case 'WipeUntilBlock': return this.wipeUntilBlock(ctx, request as $2.WipeUntilBlockRequest);
