...
const BinaryType$json = {
  ...
  '2': [
    ...
    {'1': 'BINARY_TYPE_DRIVECHAIND', '2': 12},
...
final $typed_data.Uint8List rejectOutcomeDescriptor = $convert.base64Decode(
    'Cg1SZWplY3RPdXRjb21lEh4KGlJFSkVDVF9PVVRDT01FX1VOU1BFQ0lGSUVEEAASIgoeUkVKRU'
...
final $typed_data.Uint8List resetPhaseDescriptor = $convert.base64Decode(
    'CgpSZXNldFBoYXNlEhsKF1JFU0VUX1BIQVNFX1VOU1BFQ0lGSUVEEAASFwoTUkVTRVRfUEhBU0'
...
@$core.Deprecated('Use getDatadirNetworkRequestDescriptor instead')
const GetDatadirNetworkRequest$json = {
  '1': 'GetDatadirNetworkRequest',
};

/// Descriptor for `GetDatadirNetworkRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List getDatadirNetworkRequestDescriptor = $convert.base64Decode(
    'ChhHZXREYXRhZGlyTmV0d29ya1JlcXVlc3Q=');

@$core.Deprecated('Use getDatadirNetworkResponseDescriptor instead')
const GetDatadirNetworkResponse$json = {
  '1': 'GetDatadirNetworkResponse',
  '2': [
    {'1': 'magic', '3': 1, '4': 1, '5': 9, '10': 'magic'},
    {'1': 'detected_id', '3': 2, '4': 1, '5': 9, '10': 'detectedId'},
    {'1': 'detected_name', '3': 3, '4': 1, '5': 9, '10': 'detectedName'},
...
/// Descriptor for `GetDatadirNetworkResponse`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List getDatadirNetworkResponseDescriptor = $convert.base64Decode(
...
final $typed_data.Uint8List listBinariesRequestDescriptor = $convert.base64Decode(
    'ChNMaXN0QmluYXJpZXNSZXF1ZXN0EiMKDWZvcmNlX2JhY2tlbmQYASABKAhSDGZvcmNlQmFja2'
    'VuZA==');
...
final $typed_data.Uint8List getBinaryStatusRequestDescriptor = $convert.base64Decode(
    'ChZHZXRCaW5hcnlTdGF0dXNSZXF1ZXN0EhIKBG5hbWUYASABKAlSBG5hbWUSIwoNZm9yY2VfYm'
...
final $typed_data.Uint8List getPendingNetworkGenerationResponseDescriptor = $convert.base64Decode(
    'CiNHZXRQZW5kaW5nTmV0d29ya0dlbmVyYXRpb25SZXNwb25zZRIsChJjdXJyZW50X25ldHdvcm'
...
@$core.Deprecated('Use rejectBlockRequestDescriptor instead')
const RejectBlockRequest$json = {
  '1': 'RejectBlockRequest',
  '2': [
...
/// Descriptor for `RejectBlockRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List rejectBlockRequestDescriptor = $convert.base64Decode(
    'ChJSZWplY3RCbG9ja1JlcXVlc3QSHQoKYmxvY2tfaGFzaBgBIAEoCVIJYmxvY2tIYXNoEjIKFW'
    'VuZm9yY2VyX3dhaXRfc2Vjb25kcxgCIAEoDVITZW5mb3JjZXJXYWl0U2Vjb25kcw==');

@$core.Deprecated('Use rejectBlockResponseDescriptor instead')
const RejectBlockResponse$json = {
  '1': 'RejectBlockResponse',
  '2': [
...
final $typed_data.Uint8List rejectBlockResponseDescriptor = $convert.base64Decode(
    'ChNSZWplY3RCbG9ja1Jlc3BvbnNlEh8KC2NvcmVfaGVpZ2h0GAEgASgNUgpjb3JlSGVpZ2h0Ei'
...
final $typed_data.Uint8List acceptBlockRequestDescriptor = $convert.base64Decode(
    'ChJBY2NlcHRCbG9ja1JlcXVlc3QSHQoKYmxvY2tfaGFzaBgBIAEoCVIJYmxvY2tIYXNoEjIKFW'
    'VuZm9yY2VyX3dhaXRfc2Vjb25kcxgCIAEoDVITZW5mb3JjZXJXYWl0U2Vjb25kcw==');

@$core.Deprecated('Use acceptBlockResponseDescriptor instead')
const AcceptBlockResponse$json = {
  '1': 'AcceptBlockResponse',
  '2': [
    {'1': 'core_height', '3': 1, '4': 1, '5': 13, '10': 'coreHeight'},
    {'1': 'core_tip_hash', '3': 2, '4': 1, '5': 9, '10': 'coreTipHash'},
...
final $typed_data.Uint8List acceptBlockResponseDescriptor = $convert.base64Decode(
    'ChNBY2NlcHRCbG9ja1Jlc3BvbnNlEh8KC2NvcmVfaGVpZ2h0GAEgASgNUgpjb3JlSGVpZ2h0Ei'
...
final $typed_data.Uint8List resetToBlockRequestDescriptor = $convert.base64Decode(
    'ChNSZXNldFRvQmxvY2tSZXF1ZXN0EhYKBnRhcmdldBgBIAEoCVIGdGFyZ2V0EjIKFWVuZm9yY2'
...
final $typed_data.Uint8List resetToBlockResponseDescriptor = $convert.base64Decode(
    'ChRSZXNldFRvQmxvY2tSZXNwb25zZRIxCgVwaGFzZRgBIAEoDjIbLm9yY2hlc3RyYXRvci52MS'
...
const GetBmmContextResponse$json = {
  '1': 'GetBmmContextResponse',
  '2': [
    {'1': 'mainchain_height', '3': 1, '4': 1, '5': 5, '10': 'mainchainHeight'},
    {'1': 'mainchain_tip', '3': 2, '4': 1, '5': 9, '10': 'mainchainTip'},
    {'1': 'fee_rate_sat_vb', '3': 3, '4': 1, '5': 1, '10': 'feeRateSatVb'},
    {'1': 'mempool_txns', '3': 4, '4': 1, '5': 3, '10': 'mempoolTxns'},
    {'1': 'warnings', '3': 5, '4': 1, '5': 9, '10': 'warnings'},
  ],
};
...
const GetForkStatusResponse$json = {
  ...
  '2': [
    ...
    {'1': 'network_name', '3': 10, '4': 1, '5': 9, '10': 'networkName'},
  ],
  '9': [
    {'1': 3, '2': 4},
  ],
...
const $core.Map<$core.String, $core.dynamic> OrchestratorServiceBase$json = {
  ...
  '2': [
    ...
    {'1': 'ResetToBlock', '2': '.orchestrator.v1.ResetToBlockRequest', '3': '.orchestrator.v1.ResetToBlockResponse', '6': true},
    ...
    {'1': 'GetDatadirNetwork', '2': '.orchestrator.v1.GetDatadirNetworkRequest', '3': '.orchestrator.v1.GetDatadirNetworkResponse'},
  ],
};
...
const $core.Map<$core.String, $core.Map<$core.String, $core.dynamic>> OrchestratorServiceBase$messageJson = {
  ...
  '.orchestrator.v1.RejectBlockRequest': RejectBlockRequest$json,
  ...
  '.orchestrator.v1.GetBmmContextResponse': GetBmmContextResponse$json,
  ...
  '.orchestrator.v1.GetDatadirNetworkRequest': GetDatadirNetworkRequest$json,
  '.orchestrator.v1.GetDatadirNetworkResponse': GetDatadirNetworkResponse$json,
};
...
final $typed_data.Uint8List orchestratorServiceDescriptor = $convert.base64Decode(
    ...
    'dldEVDYXNoTWlncmF0aW9uU3RhdHVzUmVzcG9uc2USagoRR2V0RGF0YWRpck5ldHdvcmsSKS5v'
    'cmNoZXN0cmF0b3IudjEuR2V0RGF0YWRpck5ldHdvcmtSZXF1ZXN0Gioub3JjaGVzdHJhdG9yLn'
    'YxLkdldERhdGFkaXJOZXR3b3JrUmVzcG9uc2U=');
