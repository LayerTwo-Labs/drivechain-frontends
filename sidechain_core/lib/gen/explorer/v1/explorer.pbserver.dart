...
abstract class ExplorerServiceBase extends $pb.GeneratedService {
  ...
  $async.Future<$6.GetSignedTransactionResponse> getSignedTransaction($pb.ServerContext ctx, $6.GetSignedTransactionRequest request);
  $async.Future<$6.RebroadcastTransactionResponse> rebroadcastTransaction($pb.ServerContext ctx, $6.RebroadcastTransactionRequest request);
  $async.Future<$6.BroadcastTransactionResponse> broadcastTransaction($pb.ServerContext ctx, $6.BroadcastTransactionRequest request);
  ...
  $pb.GeneratedMessage createRequest($core.String methodName) {
    switch (methodName) {
      ...
      case 'GetSignedTransaction': return $6.GetSignedTransactionRequest();
      case 'RebroadcastTransaction': return $6.RebroadcastTransactionRequest();
      case 'BroadcastTransaction': return $6.BroadcastTransactionRequest();
  ...
  $async.Future<$pb.GeneratedMessage> handleCall($pb.ServerContext ctx, $core.String methodName, $pb.GeneratedMessage request) {
    switch (methodName) {
      ...
      case 'GetSignedTransaction': return this.getSignedTransaction(ctx, request as $6.GetSignedTransactionRequest);
      case 'RebroadcastTransaction': return this.rebroadcastTransaction(ctx, request as $6.RebroadcastTransactionRequest);
      case 'BroadcastTransaction': return this.broadcastTransaction(ctx, request as $6.BroadcastTransactionRequest);
