...
class EstimateNewsFeeRequest extends $pb.GeneratedMessage {
  ...
  factory EstimateNewsFeeRequest.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory EstimateNewsFeeRequest.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'EstimateNewsFeeRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'misc.v1'), createEmptyInstance: create)
    ..e<NewsAction>(1, _omitFieldNames ? '' : 'action', $pb.PbFieldType.OE, defaultOrMaker: NewsAction.NEWS_ACTION_UNSPECIFIED, valueOf: NewsAction.valueOf, enumValues: NewsAction.values)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  EstimateNewsFeeRequest copyWith(void Function(EstimateNewsFeeRequest) updates) => super.copyWith((message) => updates(message as EstimateNewsFeeRequest)) as EstimateNewsFeeRequest;
  ...
  @$core.pragma('dart2js:noInline')
  static EstimateNewsFeeRequest getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<EstimateNewsFeeRequest>(create);
  static EstimateNewsFeeRequest? _defaultInstance;

  @$pb.TagNumber(1)
  NewsAction get action => $_getN(0);
  @$pb.TagNumber(1)
  set action(NewsAction v) { setField(1, v); }
  @$pb.TagNumber(1)
...
class EstimateNewsFeeResponse extends $pb.GeneratedMessage {
  ...
  factory EstimateNewsFeeResponse.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory EstimateNewsFeeResponse.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'EstimateNewsFeeResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'misc.v1'), createEmptyInstance: create)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  EstimateNewsFeeResponse copyWith(void Function(EstimateNewsFeeResponse) updates) => super.copyWith((message) => updates(message as EstimateNewsFeeResponse)) as EstimateNewsFeeResponse;
  ...
  @$core.pragma('dart2js:noInline')
  static EstimateNewsFeeResponse getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<EstimateNewsFeeResponse>(create);
  static EstimateNewsFeeResponse? _defaultInstance;

  @$pb.TagNumber(1)
  $fixnum.Int64 get vsize => $_getI64(0);
  @$pb.TagNumber(1)
  set vsize($fixnum.Int64 v) { $_setInt64(0, v); }
  @$pb.TagNumber(1)
  ...
  @$pb.TagNumber(2)
  set feeSatPerVbyte($core.double v) { $_setDouble(1, v); }
  @$pb.TagNumber(2)
  $core.bool hasFeeSatPerVbyte() => $_has(1);
  @$pb.TagNumber(2)
  void clearFeeSatPerVbyte() => clearField(2);
...
class CoinNews extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(14)
  set txid($core.String v) { $_setString(13, v); }
  @$pb.TagNumber(14)
  ...
  @$pb.TagNumber(15)
  set vout($core.int v) { $_setUnsignedInt32(14, v); }
  @$pb.TagNumber(15)
...
class MiscServiceApi {
  ...
  $async.Future<EstimateNewsFeeResponse> estimateNewsFee($pb.ClientContext? ctx, EstimateNewsFeeRequest request) =>
    _client.invoke<EstimateNewsFeeResponse>(ctx, 'MiscService', 'EstimateNewsFee', request, EstimateNewsFeeResponse())
  ;
