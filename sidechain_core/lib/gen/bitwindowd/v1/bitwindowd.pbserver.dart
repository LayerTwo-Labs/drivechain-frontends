...
abstract class BitwindowdServiceBase extends $pb.GeneratedService {
  ...
  $async.Future<$pb.GeneratedMessage> handleCall(
    ...
    switch (methodName) {
      ...
      case 'StartMining':
        return this.startMining(ctx, request as $1.Empty);
      case 'StopMining':
        return this.stopMining(ctx, request as $1.Empty);
      case 'GetMiningStatus':
        return this.getMiningStatus(ctx, request as $1.Empty);
      case 'CreateDenial':
      ...
      case 'ExportLabels':
        return this.exportLabels(ctx, request as $1.Empty);
      case 'ImportLabels':
        return this.importLabels(ctx, request as $3.ImportLabelsRequest);
      case 'GetFireplaceStats':
