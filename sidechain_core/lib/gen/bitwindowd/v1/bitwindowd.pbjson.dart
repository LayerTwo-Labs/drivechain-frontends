...
final $typed_data.Uint8List bitcoinNetworkDescriptor = $convert.base64Decode(
    ...
    'oXQklUQ09JTl9ORVRXT1JLX1RFU1RORVQQBRIZChVCSVRDT0lOX05FVFdPUktfRUNBU0gQByIE'
    'CAYQBg==');
...
const DenialInfo$json = {
  ...
  '2': [
    ...
    {'1': 'paused_at', '3': 12, '4': 1, '5': 11, '6': '.google.protobuf.Timestamp', '9': 3, '10': 'pausedAt', '17': true},
  ],
  '8': [
    {'1': '_cancel_time'},
    {'1': '_cancel_reason'},
...
final $typed_data.Uint8List denialInfoDescriptor = $convert.base64Decode(
    ...
    'NSD3RhcmdldFV0eG9TaXplcxI8CglwYXVzZWRfYXQYDCABKAsyGi5nb29nbGUucHJvdG9idWYu'
    'VGltZXN0YW1wSANSCHBhdXNlZEF0iAEBQg4KDF9jYW5jZWxfdGltZUIQCg5fY2FuY2VsX3JlYX'
    'NvbkIWChRfbmV4dF9leGVjdXRpb25fdGltZUIMCgpfcGF1c2VkX2F0');
...
@$core.Deprecated('Use pauseDenialRequestDescriptor instead')
const PauseDenialRequest$json = {
  '1': 'PauseDenialRequest',
  '2': [
    {'1': 'id', '3': 1, '4': 1, '5': 3, '10': 'id'},
  ],
};

/// Descriptor for `PauseDenialRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List pauseDenialRequestDescriptor = $convert.base64Decode(
    'ChJQYXVzZURlbmlhbFJlcXVlc3QSDgoCaWQYASABKANSAmlk');

@$core.Deprecated('Use resumeDenialRequestDescriptor instead')
const ResumeDenialRequest$json = {
  '1': 'ResumeDenialRequest',
  '2': [
    {'1': 'id', '3': 1, '4': 1, '5': 3, '10': 'id'},
  ],
};

/// Descriptor for `ResumeDenialRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List resumeDenialRequestDescriptor = $convert.base64Decode(
    'ChNSZXN1bWVEZW5pYWxSZXF1ZXN0Eg4KAmlkGAEgASgDUgJpZA==');
...
const $core.Map<$core.String, $core.dynamic> BitwindowdServiceBase$json = {
  ...
  '2': [
    ...
    {'1': 'ResumeDenial', '2': '.bitwindowd.v1.ResumeDenialRequest', '3': '.google.protobuf.Empty'},
...
const $core.Map<$core.String, $core.Map<$core.String, $core.dynamic>> BitwindowdServiceBase$messageJson = {
  ...
  '.bitwindowd.v1.ResumeDenialRequest': ResumeDenialRequest$json,
...
final $typed_data.Uint8List bitwindowdServiceDescriptor = $convert.base64Decode(
    ...
    'VydmljZVN0b3BSZXF1ZXN0GhYuZ29vZ2xlLnByb3RvYnVmLkVtcHR5EkoKDENyZWF0ZURlbmlh'
    'bBIiLmJpdHdpbmRvd2QudjEuQ3JlYXRlRGVuaWFsUmVxdWVzdBoWLmdvb2dsZS5wcm90b2J1Zi'
    '5FbXB0eRJKCgxDYW5jZWxEZW5pYWwSIi5iaXR3aW5kb3dkLnYxLkNhbmNlbERlbmlhbFJlcXVl'
    'c3QaFi5nb29nbGUucHJvdG9idWYuRW1wdHkSSAoLUGF1c2VEZW5pYWwSIS5iaXR3aW5kb3dkLn'
    'YxLlBhdXNlRGVuaWFsUmVxdWVzdBoWLmdvb2dsZS5wcm90b2J1Zi5FbXB0eRJKCgxSZXN1bWVE'
    'ZW5pYWwSIi5iaXR3aW5kb3dkLnYxLlJlc3VtZURlbmlhbFJlcXVlc3QaFi5nb29nbGUucHJvdG'
    '9idWYuRW1wdHkSdQoWQ3JlYXRlQWRkcmVzc0Jvb2tFbnRyeRIsLmJpdHdpbmRvd2QudjEuQ3Jl'
    'YXRlQWRkcmVzc0Jvb2tFbnRyeVJlcXVlc3QaLS5iaXR3aW5kb3dkLnYxLkNyZWF0ZUFkZHJlc3'
    'NCb29rRW50cnlSZXNwb25zZRJRCg9MaXN0QWRkcmVzc0Jvb2sSFi5nb29nbGUucHJvdG9idWYu'
    'RW1wdHkaJi5iaXR3aW5kb3dkLnYxLkxpc3RBZGRyZXNzQm9va1Jlc3BvbnNlEl4KFlVwZGF0ZU'
    'FkZHJlc3NCb29rRW50cnkSLC5iaXR3aW5kb3dkLnYxLlVwZGF0ZUFkZHJlc3NCb29rRW50cnlS'
    'ZXF1ZXN0GhYuZ29vZ2xlLnByb3RvYnVmLkVtcHR5El4KFkRlbGV0ZUFkZHJlc3NCb29rRW50cn'
    'kSLC5iaXR3aW5kb3dkLnYxLkRlbGV0ZUFkZHJlc3NCb29rRW50cnlSZXF1ZXN0GhYuZ29vZ2xl'
    'LnByb3RvYnVmLkVtcHR5EkkKC0dldFN5bmNJbmZvEhYuZ29vZ2xlLnByb3RvYnVmLkVtcHR5Gi'
    'IuYml0d2luZG93ZC52MS5HZXRTeW5jSW5mb1Jlc3BvbnNlElYKElNldFRyYW5zYWN0aW9uTm90'
    'ZRIoLmJpdHdpbmRvd2QudjEuU2V0VHJhbnNhY3Rpb25Ob3RlUmVxdWVzdBoWLmdvb2dsZS5wcm'
    '90b2J1Zi5FbXB0eRJLCgxFeHBvcnRMYWJlbHMSFi5nb29nbGUucHJvdG9idWYuRW1wdHkaIy5i'
    'aXR3aW5kb3dkLnYxLkV4cG9ydExhYmVsc1Jlc3BvbnNlElcKDEltcG9ydExhYmVscxIiLmJpdH'
    'dpbmRvd2QudjEuSW1wb3J0TGFiZWxzUmVxdWVzdBojLmJpdHdpbmRvd2QudjEuSW1wb3J0TGFi'
    'ZWxzUmVzcG9uc2USVQoRR2V0RmlyZXBsYWNlU3RhdHMSFi5nb29nbGUucHJvdG9idWYuRW1wdH'
    'kaKC5iaXR3aW5kb3dkLnYxLkdldEZpcmVwbGFjZVN0YXRzUmVzcG9uc2USdQoWTGlzdFJlY2Vu'
    'dFRyYW5zYWN0aW9ucxIsLmJpdHdpbmRvd2QudjEuTGlzdFJlY2VudFRyYW5zYWN0aW9uc1JlcX'
