...
import 'package:sidechain_core/gen/thunder/v1/thunder.connect.client.dart';
import 'package:sidechain_core/gen/thunder/v1/thunder.pb.dart' as pb;
...
class ThunderLive extends ThunderRPC {
  ...
  @override
  List<String> getMethods() => thunderRPCMethods;
