...
class TimestampRules extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'TimestampRules', package: const $pb.PackageName(_omitMessageNames ? '' : 'buf.validate'), createEmptyInstance: create)
    ..oo(0, [3, 4, 7])
    ..oo(1, [5, 6, 8])
    ..aOM<$0.Timestamp>(2, _omitFieldNames ? '' : 'const', subBuilder: $0.Timestamp.create)
    ..aOM<$0.Timestamp>(3, _omitFieldNames ? '' : 'lt', subBuilder: $0.Timestamp.create)
    ..aOM<$0.Timestamp>(4, _omitFieldNames ? '' : 'lte', subBuilder: $0.Timestamp.create)
    ..aOM<$0.Timestamp>(5, _omitFieldNames ? '' : 'gt', subBuilder: $0.Timestamp.create)
  ...
  ///  ```
  @$pb.TagNumber(2)
  $0.Timestamp get const_2 => $_getN(0);
  @$pb.TagNumber(2)
  set const_2($0.Timestamp v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasConst_2() => $_has(0);
  @$pb.TagNumber(2)
  void clearConst_2() => clearField(2);
  @$pb.TagNumber(2)
  $0.Timestamp ensureConst_2() => $_ensure(0);
  ...
  ///  ```
  @$pb.TagNumber(3)
  $0.Timestamp get lt => $_getN(1);
  @$pb.TagNumber(3)
  set lt($0.Timestamp v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasLt() => $_has(1);
  @$pb.TagNumber(3)
  void clearLt() => clearField(3);
  @$pb.TagNumber(3)
  $0.Timestamp ensureLt() => $_ensure(1);
  ...
  ///  ```
  @$pb.TagNumber(4)
  $0.Timestamp get lte => $_getN(2);
  @$pb.TagNumber(4)
  set lte($0.Timestamp v) { setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasLte() => $_has(2);
  @$pb.TagNumber(4)
  void clearLte() => clearField(4);
  @$pb.TagNumber(4)
  $0.Timestamp ensureLte() => $_ensure(2);
  ...
  ///  ```
  @$pb.TagNumber(5)
  $0.Timestamp get gt => $_getN(3);
  @$pb.TagNumber(5)
  set gt($0.Timestamp v) { setField(5, v); }
  @$pb.TagNumber(5)
  $core.bool hasGt() => $_has(3);
  @$pb.TagNumber(5)
  void clearGt() => clearField(5);
  @$pb.TagNumber(5)
  $0.Timestamp ensureGt() => $_ensure(3);
  ...
  ///  ```
  @$pb.TagNumber(6)
  $0.Timestamp get gte => $_getN(4);
  @$pb.TagNumber(6)
  set gte($0.Timestamp v) { setField(6, v); }
  @$pb.TagNumber(6)
  $core.bool hasGte() => $_has(4);
  @$pb.TagNumber(6)
  void clearGte() => clearField(6);
  @$pb.TagNumber(6)
  $0.Timestamp ensureGte() => $_ensure(4);
