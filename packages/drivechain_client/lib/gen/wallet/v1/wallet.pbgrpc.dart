...
class WalletServiceClient extends $grpc.Client {
  ...
  static final _$getBalance = $grpc.ClientMethod<$1.Empty, $2.GetBalanceResponse>(
      '/wallet.v1.WalletService/GetBalance',
      ($1.Empty value) => value.writeToBuffer(),
      ($core.List<$core.int> value) => $2.GetBalanceResponse.fromBuffer(value),);
  static final _$getNewAddress = $grpc.ClientMethod<$1.Empty, $2.GetNewAddressResponse>(
      '/wallet.v1.WalletService/GetNewAddress',
      ($1.Empty value) => value.writeToBuffer(),
      ($core.List<$core.int> value) => $2.GetNewAddressResponse.fromBuffer(value),);
  static final _$listTransactions = $grpc.ClientMethod<$1.Empty, $2.ListTransactionsResponse>(
  ...
  $grpc.ResponseFuture<$2.GetBalanceResponse> getBalance($1.Empty request, {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$getBalance, request, options: options);
  }

  $grpc.ResponseFuture<$2.GetNewAddressResponse> getNewAddress($1.Empty request, {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$getNewAddress, request, options: options);
  }

  $grpc.ResponseFuture<$2.ListTransactionsResponse> listTransactions($1.Empty request, {$grpc.CallOptions? options}) {
...
abstract class WalletServiceBase extends $grpc.Service {
  ...
  WalletServiceBase() {
    ...
    $addMethod($grpc.ServiceMethod<$1.Empty, $2.GetBalanceResponse>(
        'GetBalance',
        getBalance_Pre,
        false,
        false,
    ...
    $addMethod($grpc.ServiceMethod<$1.Empty, $2.GetNewAddressResponse>(
        'GetNewAddress',
        getNewAddress_Pre,
        false,
        false,
    ...
    $addMethod($grpc.ServiceMethod<$1.Empty, $2.ListTransactionsResponse>(
        'ListTransactions',
  ...
  $async.Future<$2.GetBalanceResponse> getBalance_Pre($grpc.ServiceCall call, $async.Future<$1.Empty> request) async {
    return getBalance(call, await request);
  }

  $async.Future<$2.GetNewAddressResponse> getNewAddress_Pre($grpc.ServiceCall call, $async.Future<$1.Empty> request) async {
    return getNewAddress(call, await request);
  }

  $async.Future<$2.ListTransactionsResponse> listTransactions_Pre($grpc.ServiceCall call, $async.Future<$1.Empty> request) async {
  ...
  $async.Future<$2.GetBalanceResponse> getBalance($grpc.ServiceCall call, $1.Empty request);
  $async.Future<$2.GetNewAddressResponse> getNewAddress($grpc.ServiceCall call, $1.Empty request);
  $async.Future<$2.ListTransactionsResponse> listTransactions($grpc.ServiceCall call, $1.Empty request);
}
