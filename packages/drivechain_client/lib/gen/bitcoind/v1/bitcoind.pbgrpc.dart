...
class BitcoindServiceClient extends $grpc.Client {
  static final _$listUnconfirmedTransactions =
      $grpc.ClientMethod<$0.ListUnconfirmedTransactionsRequest, $0.ListUnconfirmedTransactionsResponse>(
  ...
  $grpc.ResponseFuture<$0.ListUnconfirmedTransactionsResponse> listUnconfirmedTransactions(
      $0.ListUnconfirmedTransactionsRequest request,
      {$grpc.CallOptions? options,}) {
    return $createUnaryCall(_$listUnconfirmedTransactions, request, options: options);
  }

  $grpc.ResponseFuture<$0.ListRecentBlocksResponse> listRecentBlocks($0.ListRecentBlocksRequest request,
      {$grpc.CallOptions? options,}) {
  ...
  $grpc.ResponseFuture<$0.EstimateSmartFeeResponse> estimateSmartFee($0.EstimateSmartFeeRequest request,
      {$grpc.CallOptions? options,}) {
...
abstract class BitcoindServiceBase extends $grpc.Service {
  ...
  BitcoindServiceBase() {
    $addMethod(
      $grpc.ServiceMethod<$0.ListUnconfirmedTransactionsRequest, $0.ListUnconfirmedTransactionsResponse>(
    ...
    $addMethod(
      $grpc.ServiceMethod<$0.ListRecentBlocksRequest, $0.ListRecentBlocksResponse>(
        'ListRecentBlocks',
    ...
    $addMethod(
      $grpc.ServiceMethod<$1.Empty, $0.GetBlockchainInfoResponse>(
        'GetBlockchainInfo',
    ...
    $addMethod(
      $grpc.ServiceMethod<$1.Empty, $0.ListPeersResponse>(
        'ListPeers',
        listPeers_Pre,
        false,
        false,
    ...
    $addMethod(
      $grpc.ServiceMethod<$0.EstimateSmartFeeRequest, $0.EstimateSmartFeeResponse>(
        'EstimateSmartFee',
  ...
  $async.Future<$0.ListUnconfirmedTransactionsResponse> listUnconfirmedTransactions_Pre(
      $grpc.ServiceCall call, $async.Future<$0.ListUnconfirmedTransactionsRequest> request,) async {
    return listUnconfirmedTransactions(call, await request);
  }

  $async.Future<$0.ListRecentBlocksResponse> listRecentBlocks_Pre(
      $grpc.ServiceCall call, $async.Future<$0.ListRecentBlocksRequest> request,) async {
  ...
  $async.Future<$0.EstimateSmartFeeResponse> estimateSmartFee_Pre(
      $grpc.ServiceCall call, $async.Future<$0.EstimateSmartFeeRequest> request,) async {
    return estimateSmartFee(call, await request);
  }

  $async.Future<$0.ListUnconfirmedTransactionsResponse> listUnconfirmedTransactions(
      $grpc.ServiceCall call, $0.ListUnconfirmedTransactionsRequest request,);
  $async.Future<$0.ListRecentBlocksResponse> listRecentBlocks(
      $grpc.ServiceCall call, $0.ListRecentBlocksRequest request,);
  ...
  $async.Future<$0.EstimateSmartFeeResponse> estimateSmartFee(
      $grpc.ServiceCall call, $0.EstimateSmartFeeRequest request,);
}
