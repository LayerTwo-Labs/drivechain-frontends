...
class _SettingsResetState extends State<SettingsReset> {
  ...
  Future<void> _performReset() async {
    ...
    setState(() => _status = 'Stopping BitNames...');
    ...
    if (_deleteBlockchainData) {
      ...
      try {
        ...
        log.i('Successfully deleted BitNames blockchain data');
      } catch (e) {
    ...
    if (_deleteSettings) {
      ...
      try {
        ...
        log.i('Successfully deleted BitNames settings');
      } catch (e) {
    ...
    if (_deleteWalletFiles) {
      ...
      try {
        ...
        log.i('Successfully deleted BitNames wallet files');
      } catch (e) {
        log.e('Could not delete wallet files: $e');
      }
    }

    setState(() => _status = 'Restarting BitNames...');
    bootBinaries(log);
