...
Future<(Directory, File, Logger)> init(String arguments) async {
  ...
  SidechainRPC createSidechainConnection(Binary binary) {
    final truthcoin = GetIt.I.isRegistered<TruthcoinRPC>() ? GetIt.I.get<TruthcoinRPC>() : TruthcoinLive();
...
Future<void> initAutoUpdater(Logger log) async {
  ...
  try {
    const feedURL = 'https://releases.drivechain.info/appcast-truthcoin.xml';
