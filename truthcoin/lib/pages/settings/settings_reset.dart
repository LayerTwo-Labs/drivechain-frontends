...
class _SettingsResetState extends State<SettingsReset> {
    ...
    return SailColumn(
      ...
      children: [
        ...
        ResetOptionTile(
          ...
          title: 'Delete Truthcoin Settings',
        ...
        ResetOptionTile(
          ...
          subtitle: 'Deletes all Truthcoin data',
          isDestructive: true,
        ),
  ...
  Future<void> _performReset() async {
    ...
    final binary = Truthcoin();

    setState(() => _status = 'Stopping Truthcoin...');
    ...
    final truthcoinRPC = GetIt.I.get<TruthcoinRPC>();
    while (!truthcoinRPC.connected) {
