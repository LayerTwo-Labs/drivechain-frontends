...
@RoutePage()
class TruthcoinHomepagePage extends StatelessWidget {
  const TruthcoinHomepagePage({super.key});

  @override
  Widget build(BuildContext context) {
    return ViewModelBuilder.reactive(
      viewModelBuilder: () => TruthcoinHomepageViewModel(),
...
class TruthcoinHomepageViewModel extends BaseViewModel {
  TruthcoinHomepageProvider get _homepageProvider => GetIt.I.get<TruthcoinHomepageProvider>();
