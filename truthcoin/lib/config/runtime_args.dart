...
abstract class RuntimeArgs {
  ...
  static Future<Directory> datadir() async {
    final fromEnv = Platform.environment['TRUTHCOIN_DATADIR'] ?? const String.fromEnvironment('TRUTHCOIN_DATADIR');
  ...
  static bool consoleLog = Platform.environment['TRUTHCOIN_LOG_CONSOLE']?.isNotEmpty ?? false;

  static bool fileLog = Platform.environment['TRUTHCOIN_LOG_FILE']?.isNotEmpty ?? false;

  static final String _network =
      Platform.environment['TRUTHCOIN_NETWORK'] ?? const String.fromEnvironment('TRUTHCOIN_NETWORK');
