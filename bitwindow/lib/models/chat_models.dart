enum ChatRelationshipState {
  none,
  outgoingIntroduction,
...
class ChatMessage {
  ...
  ChatMessage({
    ...
    this.kind = ChatMessageKind.message,
    this.deliveryState = ChatDeliveryState.pending,
    this.transport = ChatTransport.bitnamesChain,
    this.introductionId,
    this.txid,
    this.valueSats,
    this.error,
...
class ChatContact {
  ...
  final ChatRelationshipState relationshipState;
  final String? introductionId;
  ...
  ChatContact({
    ...
    this.address,
    this.paymailFeeSats,
    this.relationshipState = ChatRelationshipState.none,
    this.introductionId,
    this.replyProfile,
    this.lastMessage,
  ...
  factory ChatContact.fromJson(Map<String, dynamic> json) => ChatContact(
    ...
    signingPubkey: json['signing_pubkey'],
  ...
  ChatContact copyWith({
    ...
    String? address,
    int? paymailFeeSats,
    ChatRelationshipState? relationshipState,
    String? introductionId,
