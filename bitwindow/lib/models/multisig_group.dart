...
class AddressInfo {
  ...
  final bool used;
  AddressInfo({required this.index, required this.address, this.used = false});
  factory AddressInfo.fromJson(Map<String, dynamic> json) =>
      AddressInfo(index: json['index'] ?? 0, address: json['address'] ?? '', used: json['used'] ?? false);
  Map<String, dynamic> toJson() => {'index': index, 'address': address, 'used': used};
}
...
class UtxoInfo {
  ...
  Map<String, dynamic> get outpoint => {'txid': txid, 'vout': vout};
}
