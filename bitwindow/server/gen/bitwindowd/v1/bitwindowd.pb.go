...
const (
	...
	BitcoinNetwork_BITCOIN_NETWORK_DRYNET      BitcoinNetwork = 7
)
...
const file_bitwindowd_v1_bitwindowd_proto_rawDesc = "" +
	...
	"\x11DIRECTION_RECEIVE\x10\x02*\xfa\x01\n" +
	...
	"\x17BITCOIN_NETWORK_FORKNET\x10\x06\x12\x1a\n" +
	"\x16BITCOIN_NETWORK_DRYNET\x10\a*\xac\x01\n" +
