...
const (
	...
	// The network dropped a sidechain deposit, so it can never confirm and
	// the user must send it again.
	SystemEvent_TYPE_DEPOSIT_DROPPED SystemEvent_Type = 5
)
...
const file_notification_v1_notification_proto_rawDesc = "" +
	...
	"\x10TYPE_BLOCK_FOUND\x10\x04\x12\x18\n" +
	"\x14TYPE_DEPOSIT_DROPPED\x10\x05\"\xff\x02\n" +
