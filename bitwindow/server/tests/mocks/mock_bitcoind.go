...
//
//	mockgen -destination=tests/mocks/mock_bitcoind.go -package=mocks github.com/barebitcoin/btc-buf/gen/bitcoin/bitcoind/v1alpha/bitcoindv1alphaconnect BitcoinServiceClient
//
