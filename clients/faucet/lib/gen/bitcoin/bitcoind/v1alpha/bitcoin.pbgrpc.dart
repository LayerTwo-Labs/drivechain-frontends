...
import 'package:faucet/gen/google/protobuf/empty.pb.dart' as $1;
import 'package:faucet/gen/bitcoin/bitcoind/v1alpha/bitcoin.pb.dart' as $0;
...
class BitcoinServiceClient extends $grpc.Client {
  ...
  static final _$getPeerInfo = $grpc.ClientMethod<$0.GetPeerInfoRequest, $0.GetPeerInfoResponse>(
      '/bitcoin.bitcoind.v1alpha.BitcoinService/GetPeerInfo',
      ($0.GetPeerInfoRequest value) => value.writeToBuffer(),
      ($core.List<$core.int> value) => $0.GetPeerInfoResponse.fromBuffer(value),);
  ...
  static final _$listWallets = $grpc.ClientMethod<$1.Empty, $0.ListWalletsResponse>(
      '/bitcoin.bitcoind.v1alpha.BitcoinService/ListWallets',
      ($1.Empty value) => value.writeToBuffer(),
      ($core.List<$core.int> value) => $0.ListWalletsResponse.fromBuffer(value),);
  ...
  static final _$getAddressInfo = $grpc.ClientMethod<$0.GetAddressInfoRequest, $0.GetAddressInfoResponse>(
      '/bitcoin.bitcoind.v1alpha.BitcoinService/GetAddressInfo',
      ($0.GetAddressInfoRequest value) => value.writeToBuffer(),
      ($core.List<$core.int> value) => $0.GetAddressInfoResponse.fromBuffer(value),);
  ...
  $grpc.ResponseFuture<$0.GetPeerInfoResponse> getPeerInfo($0.GetPeerInfoRequest request, {$grpc.CallOptions? options}) {
  ...
  $grpc.ResponseFuture<$0.ListWalletsResponse> listWallets($1.Empty request, {$grpc.CallOptions? options}) {
  ...
  $grpc.ResponseFuture<$0.GetAddressInfoResponse> getAddressInfo($0.GetAddressInfoRequest request, {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$getAddressInfo, request, options: options);
  }
...
abstract class BitcoinServiceBase extends $grpc.Service {
  ...
  BitcoinServiceBase() {
    ...
    $addMethod($grpc.ServiceMethod<$0.GetPeerInfoRequest, $0.GetPeerInfoResponse>(
        'GetPeerInfo',
        getPeerInfo_Pre,
        false,
        false,
        ($core.List<$core.int> value) => $0.GetPeerInfoRequest.fromBuffer(value),
        ($0.GetPeerInfoResponse value) => value.writeToBuffer(),),);
    ...
    $addMethod($grpc.ServiceMethod<$1.Empty, $0.ListWalletsResponse>(
        'ListWallets',
        listWallets_Pre,
        false,
        false,
    ...
    $addMethod($grpc.ServiceMethod<$0.GetAddressInfoRequest, $0.GetAddressInfoResponse>(
        'GetAddressInfo',
        getAddressInfo_Pre,
        false,
        false,
        ($core.List<$core.int> value) => $0.GetAddressInfoRequest.fromBuffer(value),
        ($0.GetAddressInfoResponse value) => value.writeToBuffer(),),);
  ...
  $async.Future<$0.GetPeerInfoResponse> getPeerInfo_Pre($grpc.ServiceCall call, $async.Future<$0.GetPeerInfoRequest> request) async {
  ...
  $async.Future<$0.ListWalletsResponse> listWallets_Pre($grpc.ServiceCall call, $async.Future<$1.Empty> request) async {
  ...
  $async.Future<$0.GetAddressInfoResponse> getAddressInfo_Pre($grpc.ServiceCall call, $async.Future<$0.GetAddressInfoRequest> request) async {
    return getAddressInfo(call, await request);
  }
  ...
  $async.Future<$0.GetPeerInfoResponse> getPeerInfo($grpc.ServiceCall call, $0.GetPeerInfoRequest request);
  ...
  $async.Future<$0.ListWalletsResponse> listWallets($grpc.ServiceCall call, $1.Empty request);
  ...
  $async.Future<$0.GetAddressInfoResponse> getAddressInfo($grpc.ServiceCall call, $0.GetAddressInfoRequest request);
