...
import 'package:faucet/gen/bitcoin/drivechaind/v1/drivechain.pb.dart' as $1;
...
class DrivechainServiceClient extends $grpc.Client {
  static final _$createSidechainDeposit =
      $grpc.ClientMethod<$1.CreateSidechainDepositRequest, $1.CreateSidechainDepositResponse>(
  ...
  $grpc.ResponseFuture<$1.CreateSidechainDepositResponse> createSidechainDeposit(
      $1.CreateSidechainDepositRequest request,
      {$grpc.CallOptions? options}) {
...
abstract class DrivechainServiceBase extends $grpc.Service {
  ...
  DrivechainServiceBase() {
    $addMethod(
      $grpc.ServiceMethod<$1.CreateSidechainDepositRequest, $1.CreateSidechainDepositResponse>(
  ...
  $async.Future<$1.CreateSidechainDepositResponse> createSidechainDeposit_Pre(
      $grpc.ServiceCall call, $async.Future<$1.CreateSidechainDepositRequest> request) async {
    return createSidechainDeposit(call, await request);
  }

  $async.Future<$1.CreateSidechainDepositResponse> createSidechainDeposit(
      $grpc.ServiceCall call, $1.CreateSidechainDepositRequest request);
}
