...
abstract class ZSidedRPC extends SidechainRPC {
  ZSidedRPC({required super.binaryType, required super.restartOnFailure});
...
class ZSidedLive extends ZSidedRPC {
  ...
  ZSidedLive() : super(binaryType: BinaryType.zSided, restartOnFailure: false) {
  ...
  Future<ZSideBalanceBreakdown> getBalanceBreakdown() async {
    final response = await _client.getBalanceBreakdown(
  ...
  Future<String> getDepositAddress() async {
    final response = await _client.getNewTransparentAddress(
      GetNewTransparentAddressRequest(),
    );
  ...
  Future<String> getNewShieldedAddress() async {
    final response = await _client.getNewShieldedAddress(
      GetNewShieldedAddressRequest(),
    );
    return response.address;
  }
  ...
  Future<List<String>> getShieldedWalletAddresses() async {
    final response = await _client.getShieldedWalletAddresses(
      GetShieldedWalletAddressesRequest(),
    );
  ...
  Future<List<String>> getTransparentWalletAddresses() async {
    final response = await _client.getTransparentWalletAddresses(
      GetTransparentWalletAddressesRequest(),
    );
    return response.addresses;
  }
