...
class FrontendWalletReaderProvider extends WalletReaderProvider {
  @override
  ...
  FrontendWalletReaderProvider(this.bitwindowAppDir) {
  ...
  @override
  Future<bool> hasWallet() async => getWalletFile().existsSync();
