...
class ShutDownRoute extends _i6.PageRouteInfo<ShutDownRouteArgs> {
  ShutDownRoute({
    ...
    _i7.VoidCallback? onForceKillRequested,
    List<_i6.PageRouteInfo>? children,
  }) : super(
         ShutDownRoute.name,
...
class ShutDownRouteArgs {
  ...
  final _i7.VoidCallback? onForceKillRequested;
  ...
  bool operator ==(Object other) {
    ...
    return key == other.key &&
        const _i10.ListEquality<_i8.Binary>().equals(
          binaries,
          other.binaries,
        ) &&
  ...
  int get hashCode =>
      key.hashCode ^
      const _i10.ListEquality<_i8.Binary>().hash(binaries) ^
