...
abstract class BitcoinServiceBase extends $pb.GeneratedService {
  ...
  $async.Future<$4.AddMultisigAddressResponse> addMultisigAddress($pb.ServerContext ctx, $4.AddMultisigAddressRequest request);
  ...
  $pb.GeneratedMessage createRequest($core.String methodName) {
    switch (methodName) {
      ...
      case 'DumpWallet': return $4.DumpWalletRequest();
      case 'ImportWallet': return $4.ImportWalletRequest();
      case 'UnloadWallet': return $4.UnloadWalletRequest();
      case 'DumpPrivKey': return $4.DumpPrivKeyRequest();
      case 'ImportPrivKey': return $4.ImportPrivKeyRequest();
      case 'ImportAddress': return $4.ImportAddressRequest();
      case 'ImportPubKey': return $4.ImportPubKeyRequest();
      ...
      case 'AddMultisigAddress': return $4.AddMultisigAddressRequest();
  ...
  $async.Future<$pb.GeneratedMessage> handleCall($pb.ServerContext ctx, $core.String methodName, $pb.GeneratedMessage request) {
    switch (methodName) {
      ...
      case 'DumpWallet': return this.dumpWallet(ctx, request as $4.DumpWalletRequest);
      case 'ImportWallet': return this.importWallet(ctx, request as $4.ImportWalletRequest);
      case 'UnloadWallet': return this.unloadWallet(ctx, request as $4.UnloadWalletRequest);
      case 'DumpPrivKey': return this.dumpPrivKey(ctx, request as $4.DumpPrivKeyRequest);
      case 'ImportPrivKey': return this.importPrivKey(ctx, request as $4.ImportPrivKeyRequest);
      case 'ImportAddress': return this.importAddress(ctx, request as $4.ImportAddressRequest);
      case 'ImportPubKey': return this.importPubKey(ctx, request as $4.ImportPubKeyRequest);
      ...
      case 'AddMultisigAddress': return this.addMultisigAddress(ctx, request as $4.AddMultisigAddressRequest);
