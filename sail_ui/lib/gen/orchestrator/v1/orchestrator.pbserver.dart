...
abstract class OrchestratorServiceBase extends $pb.GeneratedService {
  ...
  $async.Future<$5.GetDownloadStatusResponse> getDownloadStatus(
      $pb.ServerContext ctx, $5.GetDownloadStatusRequest request);
  ...
  $pb.GeneratedMessage createRequest($core.String methodName) {
    switch (methodName) {
      ...
      case 'GetDownloadStatus':
        return $5.GetDownloadStatusRequest();
  ...
  $async.Future<$pb.GeneratedMessage> handleCall(
    ...
    switch (methodName) {
      ...
      case 'GetDownloadStatus':
        return this.getDownloadStatus(ctx, request as $5.GetDownloadStatusRequest);
      case 'GetMainchainBalance':
