...
class MineBlocksResponse_HashRate extends $pb.GeneratedMessage {
  ...
  factory MineBlocksResponse_HashRate.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory MineBlocksResponse_HashRate.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'MineBlocksResponse.HashRate',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'bitwindowd.v1'), createEmptyInstance: create)
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  MineBlocksResponse_HashRate copyWith(void Function(MineBlocksResponse_HashRate) updates) =>
      super.copyWith((message) => updates(message as MineBlocksResponse_HashRate)) as MineBlocksResponse_HashRate;
  ...
  @$core.pragma('dart2js:noInline')
  static MineBlocksResponse_HashRate getDefault() =>
      _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<MineBlocksResponse_HashRate>(create);
...
class MineBlocksResponse_BlockFound extends $pb.GeneratedMessage {
  ...
  factory MineBlocksResponse_BlockFound.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory MineBlocksResponse_BlockFound.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'MineBlocksResponse.BlockFound',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'bitwindowd.v1'), createEmptyInstance: create)
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  MineBlocksResponse_BlockFound copyWith(void Function(MineBlocksResponse_BlockFound) updates) =>
      super.copyWith((message) => updates(message as MineBlocksResponse_BlockFound)) as MineBlocksResponse_BlockFound;
  ...
  @$core.pragma('dart2js:noInline')
  static MineBlocksResponse_BlockFound getDefault() =>
      _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<MineBlocksResponse_BlockFound>(create);
...
enum MineBlocksResponse_Event { blockFound, hashRate, notSet }
...
class MineBlocksResponse extends $pb.GeneratedMessage {
  ...
  factory MineBlocksResponse.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory MineBlocksResponse.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'MineBlocksResponse',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'bitwindowd.v1'), createEmptyInstance: create)
    ..oo(0, [1, 2])
    ..aOM<MineBlocksResponse_BlockFound>(1, _omitFieldNames ? '' : 'blockFound',
        subBuilder: MineBlocksResponse_BlockFound.create)
    ..aOM<MineBlocksResponse_HashRate>(2, _omitFieldNames ? '' : 'hashRate',
        subBuilder: MineBlocksResponse_HashRate.create)
    ..hasRequiredFields = false;
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  MineBlocksResponse copyWith(void Function(MineBlocksResponse) updates) =>
      super.copyWith((message) => updates(message as MineBlocksResponse)) as MineBlocksResponse;
  ...
  @$core.pragma('dart2js:noInline')
  static MineBlocksResponse getDefault() =>
      _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<MineBlocksResponse>(create);
  ...
  @$pb.TagNumber(1)
  set blockFound(MineBlocksResponse_BlockFound v) {
    setField(1, v);
  }
  ...
  @$pb.TagNumber(2)
  set hashRate(MineBlocksResponse_HashRate v) {
    setField(2, v);
  }
...
class UpdateNetworkRequest extends $pb.GeneratedMessage {
  ...
  /// Target network: signet, mainnet, forknet, testnet, regtest.
  @$pb.TagNumber(1)
