...
abstract class BitwindowdServiceBase extends $pb.GeneratedService {
  ...
  $async.Future<$2.CreateAddressBookEntryResponse> createAddressBookEntry(
      $pb.ServerContext ctx, $2.CreateAddressBookEntryRequest request);
  ...
  $async.Future<$2.ListRecentTransactionsResponse> listRecentTransactions(
      $pb.ServerContext ctx, $2.ListRecentTransactionsRequest request);
  ...
  $pb.GeneratedMessage createRequest($core.String methodName) {
    switch (methodName) {
      case 'Stop':
        return $1.Empty();
      case 'CreateDenial':
        return $2.CreateDenialRequest();
      case 'CancelDenial':
        return $2.CancelDenialRequest();
      case 'CreateAddressBookEntry':
        return $2.CreateAddressBookEntryRequest();
      case 'ListAddressBook':
        return $1.Empty();
      case 'UpdateAddressBookEntry':
        return $2.UpdateAddressBookEntryRequest();
      case 'DeleteAddressBookEntry':
        return $2.DeleteAddressBookEntryRequest();
      case 'GetSyncInfo':
        return $1.Empty();
      case 'SetTransactionNote':
        return $2.SetTransactionNoteRequest();
      case 'GetFireplaceStats':
        return $1.Empty();
      case 'ListRecentTransactions':
        return $2.ListRecentTransactionsRequest();
      case 'ListBlocks':
        return $2.ListBlocksRequest();
      default:
  ...
  $async.Future<$pb.GeneratedMessage> handleCall(
    ...
    switch (methodName) {
      case 'Stop':
        return this.stop(ctx, request as $1.Empty);
      case 'CreateDenial':
        return this.createDenial(ctx, request as $2.CreateDenialRequest);
      case 'CancelDenial':
        return this.cancelDenial(ctx, request as $2.CancelDenialRequest);
      case 'CreateAddressBookEntry':
        return this.createAddressBookEntry(ctx, request as $2.CreateAddressBookEntryRequest);
      case 'ListAddressBook':
        return this.listAddressBook(ctx, request as $1.Empty);
      case 'UpdateAddressBookEntry':
        return this.updateAddressBookEntry(ctx, request as $2.UpdateAddressBookEntryRequest);
      case 'DeleteAddressBookEntry':
        return this.deleteAddressBookEntry(ctx, request as $2.DeleteAddressBookEntryRequest);
      case 'GetSyncInfo':
        return this.getSyncInfo(ctx, request as $1.Empty);
      case 'SetTransactionNote':
        return this.setTransactionNote(ctx, request as $2.SetTransactionNoteRequest);
      case 'GetFireplaceStats':
        return this.getFireplaceStats(ctx, request as $1.Empty);
      case 'ListRecentTransactions':
        return this.listRecentTransactions(ctx, request as $2.ListRecentTransactionsRequest);
      case 'ListBlocks':
        return this.listBlocks(ctx, request as $2.ListBlocksRequest);
      default:
        throw $core.ArgumentError('Unknown method: $methodName');
    }
  }
