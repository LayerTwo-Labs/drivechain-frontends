...
abstract class BitwindowdServiceBase extends $pb.GeneratedService {
  $async.Future<$1.Empty> stop($pb.ServerContext ctx, $2.BitwindowdServiceStopRequest request);
  ...
  $async.Future<$2.GetNetworkStatsResponse> getNetworkStats($pb.ServerContext ctx, $1.Empty request);

  $pb.GeneratedMessage createRequest($core.String methodName) {
    switch (methodName) {
      case 'Stop': return $2.BitwindowdServiceStopRequest();
  ...
  $async.Future<$pb.GeneratedMessage> handleCall($pb.ServerContext ctx, $core.String methodName, $pb.GeneratedMessage request) {
    switch (methodName) {
      case 'Stop': return this.stop(ctx, request as $2.BitwindowdServiceStopRequest);
