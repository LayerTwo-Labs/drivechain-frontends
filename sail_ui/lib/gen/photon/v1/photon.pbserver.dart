...
abstract class PhotonServiceBase extends $pb.GeneratedService {
  ...
  $async.Future<$10.ForgetPeerResponse> forgetPeer($pb.ServerContext ctx, $10.ForgetPeerRequest request);
  ...
  $async.Future<$10.GetWalletAddressesResponse> getWalletAddresses($pb.ServerContext ctx, $10.GetWalletAddressesRequest request);
  ...
  $pb.GeneratedMessage createRequest($core.String methodName) {
    switch (methodName) {
      ...
      case 'ForgetPeer': return $10.ForgetPeerRequest();
      ...
      case 'GetWalletAddresses': return $10.GetWalletAddressesRequest();
  ...
  $async.Future<$pb.GeneratedMessage> handleCall($pb.ServerContext ctx, $core.String methodName, $pb.GeneratedMessage request) {
    switch (methodName) {
      ...
      case 'ForgetPeer': return this.forgetPeer(ctx, request as $10.ForgetPeerRequest);
      ...
      case 'GetWalletAddresses': return this.getWalletAddresses(ctx, request as $10.GetWalletAddressesRequest);
      default: throw $core.ArgumentError('Unknown method: $methodName');
    }
  }
