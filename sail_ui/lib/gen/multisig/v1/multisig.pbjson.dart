...
final $typed_data.Uint8List txStatusDescriptor = $convert.base64Decode(
    'CghUeFN0YXR1cxIZChVUWF9TVEFUVVNfVU5TUEVDSUZJRUQQABIeChpUWF9TVEFUVVNfTkVFRF'
...
final $typed_data.Uint8List txTypeDescriptor = $convert.base64Decode(
    'CgZUeFR5cGUSFwoTVFhfVFlQRV9VTlNQRUNJRklFRBAAEhMKD1RYX1RZUEVfREVQT1NJVBABEh'
...
const MultisigKey$json = {
  ...
  '2': [
    ...
    {'1': 'active_psbts', '3': 7, '4': 3, '5': 11, '6': '.multisig.v1.MultisigKey.ActivePsbtsEntry', '10': 'activePsbts'},
    {'1': 'initial_psbts', '3': 8, '4': 3, '5': 11, '6': '.multisig.v1.MultisigKey.InitialPsbtsEntry', '10': 'initialPsbts'},
  ],
...
final $typed_data.Uint8List multisigKeyDescriptor = $convert.base64Decode(
    'CgtNdWx0aXNpZ0tleRIUCgVvd25lchgBIAEoCVIFb3duZXISEgoEeHB1YhgCIAEoCVIEeHB1Yh'
...
final $typed_data.Uint8List addressInfoDescriptor = $convert.base64Decode(
    'CgtBZGRyZXNzSW5mbxIUCgVpbmRleBgBIAEoBVIFaW5kZXgSGAoHYWRkcmVzcxgCIAEoCVIHYW'
...
final $typed_data.Uint8List utxoDetailDescriptor = $convert.base64Decode(
    'CgpVdHhvRGV0YWlsEhIKBHR4aWQYASABKAlSBHR4aWQSEgoEdm91dBgCIAEoBVIEdm91dBIYCg'
...
final $typed_data.Uint8List listGroupsResponseDescriptor = $convert.base64Decode(
    'ChJMaXN0R3JvdXBzUmVzcG9uc2USMgoGZ3JvdXBzGAEgAygLMhoubXVsdGlzaWcudjEuTXVsdG'
...
final $typed_data.Uint8List saveGroupRequestDescriptor = $convert.base64Decode(
    'ChBTYXZlR3JvdXBSZXF1ZXN0EjAKBWdyb3VwGAEgASgLMhoubXVsdGlzaWcudjEuTXVsdGlzaW'
    'dHcm91cFIFZ3JvdXA=');
...
final $typed_data.Uint8List saveGroupResponseDescriptor = $convert.base64Decode(
    'ChFTYXZlR3JvdXBSZXNwb25zZRIwCgVncm91cBgBIAEoCzIaLm11bHRpc2lnLnYxLk11bHRpc2'
    'lnR3JvdXBSBWdyb3Vw');
...
final $typed_data.Uint8List keyPSBTStatusDescriptor = $convert.base64Decode(
    'Cg1LZXlQU0JUU3RhdHVzEhUKBmtleV9pZBgBIAEoCVIFa2V5SWQSEgoEcHNidBgCIAEoCVIEcH'
...
final $typed_data.Uint8List multisigTransactionDescriptor = $convert.base64Decode(
    'ChNNdWx0aXNpZ1RyYW5zYWN0aW9uEg4KAmlkGAEgASgJUgJpZBIZCghncm91cF9pZBgCIAEoCV'
...
final $typed_data.Uint8List listTransactionsRequestDescriptor = $convert.base64Decode(
    'ChdMaXN0VHJhbnNhY3Rpb25zUmVxdWVzdBIZCghncm91cF9pZBgBIAEoCVIHZ3JvdXBJZA==');
...
final $typed_data.Uint8List listTransactionsResponseDescriptor = $convert.base64Decode(
    'ChhMaXN0VHJhbnNhY3Rpb25zUmVzcG9uc2USRAoMdHJhbnNhY3Rpb25zGAEgAygLMiAubXVsdG'
...
final $typed_data.Uint8List getTransactionByTxidRequestDescriptor = $convert.base64Decode(
    'ChtHZXRUcmFuc2FjdGlvbkJ5VHhpZFJlcXVlc3QSEgoEdHhpZBgBIAEoCVIEdHhpZA==');
...
final $typed_data.Uint8List saveTransactionRequestDescriptor = $convert.base64Decode(
    'ChZTYXZlVHJhbnNhY3Rpb25SZXF1ZXN0EkIKC3RyYW5zYWN0aW9uGAEgASgLMiAubXVsdGlzaW'
...
final $typed_data.Uint8List saveTransactionResponseDescriptor = $convert.base64Decode(
    'ChdTYXZlVHJhbnNhY3Rpb25SZXNwb25zZRJCCgt0cmFuc2FjdGlvbhgBIAEoCzIgLm11bHRpc2'
...
final $typed_data.Uint8List soloKeyDescriptor = $convert.base64Decode(
    'CgdTb2xvS2V5EhIKBHhwdWIYASABKAlSBHhwdWISJwoPZGVyaXZhdGlvbl9wYXRoGAIgASgJUg'
...
final $typed_data.Uint8List listSoloKeysResponseDescriptor = $convert.base64Decode(
    'ChRMaXN0U29sb0tleXNSZXNwb25zZRIoCgRrZXlzGAEgAygLMhQubXVsdGlzaWcudjEuU29sb0'
    'tleVIEa2V5cw==');
...
final $typed_data.Uint8List addSoloKeyRequestDescriptor = $convert.base64Decode(
    'ChFBZGRTb2xvS2V5UmVxdWVzdBImCgNrZXkYASABKAsyFC5tdWx0aXNpZy52MS5Tb2xvS2V5Ug'
    'NrZXk=');
...
final $typed_data.Uint8List getNextAccountIndexRequestDescriptor = $convert.base64Decode(
    'ChpHZXROZXh0QWNjb3VudEluZGV4UmVxdWVzdBI2ChdhZGRpdGlvbmFsX3VzZWRfaW5kaWNlcx'
...
final $typed_data.Uint8List getNextAccountIndexResponseDescriptor = $convert.base64Decode(
    'ChtHZXROZXh0QWNjb3VudEluZGV4UmVzcG9uc2USHQoKbmV4dF9pbmRleBgBIAEoBVIJbmV4dE'
    'luZGV4');
...
const $core.Map<$core.String, $core.dynamic> MultisigServiceBase$json = {
  ...
  '2': [
    ...
    {'1': 'ListTransactions', '2': '.multisig.v1.ListTransactionsRequest', '3': '.multisig.v1.ListTransactionsResponse'},
    {'1': 'GetTransaction', '2': '.multisig.v1.GetTransactionRequest', '3': '.multisig.v1.MultisigTransaction'},
    {'1': 'GetTransactionByTxid', '2': '.multisig.v1.GetTransactionByTxidRequest', '3': '.multisig.v1.MultisigTransaction'},
    ...
    {'1': 'GetNextAccountIndex', '2': '.multisig.v1.GetNextAccountIndexRequest', '3': '.multisig.v1.GetNextAccountIndexResponse'},
  ],
};
...
final $typed_data.Uint8List multisigServiceDescriptor = $convert.base64Decode(
    'Cg9NdWx0aXNpZ1NlcnZpY2USRQoKTGlzdEdyb3VwcxIWLmdvb2dsZS5wcm90b2J1Zi5FbXB0eR'
