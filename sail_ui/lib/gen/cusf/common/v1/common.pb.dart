...
class ConsensusHex extends $pb.GeneratedMessage {
  ...
  factory ConsensusHex.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory ConsensusHex.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ConsensusHex',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'cusf.common.v1'), createEmptyInstance: create)
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      ...
      'Will be removed in next major version')
  ConsensusHex copyWith(void Function(ConsensusHex) updates) =>
      super.copyWith((message) => updates(message as ConsensusHex)) as ConsensusHex;
...
class Hex extends $pb.GeneratedMessage {
  ...
  Hex._() : super();
  factory Hex.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory Hex.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Hex',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'cusf.common.v1'), createEmptyInstance: create)
    ..aOM<$0.StringValue>(1, _omitFieldNames ? '' : 'hex', subBuilder: $0.StringValue.create)
    ..hasRequiredFields = false;
...
class ReverseHex extends $pb.GeneratedMessage {
  ...
  ReverseHex._() : super();
  factory ReverseHex.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory ReverseHex.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ReverseHex',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'cusf.common.v1'), createEmptyInstance: create)
    ..aOM<$0.StringValue>(1, _omitFieldNames ? '' : 'hex', subBuilder: $0.StringValue.create)
    ..hasRequiredFields = false;
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  ReverseHex copyWith(void Function(ReverseHex) updates) =>
      super.copyWith((message) => updates(message as ReverseHex)) as ReverseHex;
