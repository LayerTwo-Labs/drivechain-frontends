...
final $typed_data.Uint8List hmacSha512RequestDescriptor =
    $convert.base64Decode('ChFIbWFjU2hhNTEyUmVxdWVzdBIlCgNrZXkYASABKAsyEy5jdXNmLmNvbW1vbi52MS5IZXhSA2'
...
final $typed_data.Uint8List hmacSha512ResponseDescriptor =
    $convert.base64Decode('ChJIbWFjU2hhNTEyUmVzcG9uc2USJwoEaG1hYxgBIAEoCzITLmN1c2YuY29tbW9uLnYxLkhleF'
        'IEaG1hYw==');
...
final $typed_data.Uint8List ripemd160RequestDescriptor =
    $convert.base64Decode('ChBSaXBlbWQxNjBSZXF1ZXN0EiUKA21zZxgBIAEoCzITLmN1c2YuY29tbW9uLnYxLkhleFIDbX'
        'Nn');
...
final $typed_data.Uint8List ripemd160ResponseDescriptor =
    $convert.base64Decode('ChFSaXBlbWQxNjBSZXNwb25zZRIrCgZkaWdlc3QYASABKAsyEy5jdXNmLmNvbW1vbi52MS5IZX'
        'hSBmRpZ2VzdA==');
...
final $typed_data.Uint8List secp256k1SecretKeyToPublicKeyRequestDescriptor =
    $convert.base64Decode('CiRTZWNwMjU2azFTZWNyZXRLZXlUb1B1YmxpY0tleVJlcXVlc3QSOwoKc2VjcmV0X2tleRgBIA'
...
final $typed_data.Uint8List secp256k1SecretKeyToPublicKeyResponseDescriptor =
    $convert.base64Decode('CiVTZWNwMjU2azFTZWNyZXRLZXlUb1B1YmxpY0tleVJlc3BvbnNlEjsKCnB1YmxpY19rZXkYAS'
...
final $typed_data.Uint8List secp256k1SignRequestDescriptor =
    $convert.base64Decode('ChRTZWNwMjU2azFTaWduUmVxdWVzdBItCgdtZXNzYWdlGAEgASgLMhMuY3VzZi5jb21tb24udj'
...
final $typed_data.Uint8List secp256k1SignResponseDescriptor =
    $convert.base64Decode('ChVTZWNwMjU2azFTaWduUmVzcG9uc2USMQoJc2lnbmF0dXJlGAEgASgLMhMuY3VzZi5jb21tb2'
...
final $typed_data.Uint8List secp256k1VerifyRequestDescriptor =
    $convert.base64Decode('ChZTZWNwMjU2azFWZXJpZnlSZXF1ZXN0Ei0KB21lc3NhZ2UYASABKAsyEy5jdXNmLmNvbW1vbi'
...
final $typed_data.Uint8List secp256k1VerifyResponseDescriptor =
    $convert.base64Decode('ChdTZWNwMjU2azFWZXJpZnlSZXNwb25zZRIUCgV2YWxpZBgBIAEoCFIFdmFsaWQ=');
...
const $core.Map<$core.String, $core.dynamic> CryptoServiceBase$json = {
  ...
  '2': [
    ...
    {
      '1': 'Secp256k1SecretKeyToPublicKey',
      '2': '.cusf.crypto.v1.Secp256k1SecretKeyToPublicKeyRequest',
      '3': '.cusf.crypto.v1.Secp256k1SecretKeyToPublicKeyResponse'
    },
    {'1': 'Secp256k1Sign', '2': '.cusf.crypto.v1.Secp256k1SignRequest', '3': '.cusf.crypto.v1.Secp256k1SignResponse'},
    {
      '1': 'Secp256k1Verify',
      '2': '.cusf.crypto.v1.Secp256k1VerifyRequest',
      '3': '.cusf.crypto.v1.Secp256k1VerifyResponse'
    },
  ],
};
...
final $typed_data.Uint8List cryptoServiceDescriptor =
    $convert.base64Decode('Cg1DcnlwdG9TZXJ2aWNlElMKCkhtYWNTaGE1MTISIS5jdXNmLmNyeXB0by52MS5IbWFjU2hhNT'
