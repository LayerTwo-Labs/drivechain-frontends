...
abstract class CryptoServiceBase extends $pb.GeneratedService {
  ...
  $async.Future<$2.Secp256k1SecretKeyToPublicKeyResponse> secp256k1SecretKeyToPublicKey(
      $pb.ServerContext ctx, $2.Secp256k1SecretKeyToPublicKeyRequest request);
  ...
  $pb.GeneratedMessage createRequest($core.String methodName) {
    switch (methodName) {
      case 'HmacSha512':
        return $2.HmacSha512Request();
      case 'Ripemd160':
        return $2.Ripemd160Request();
      case 'Secp256k1SecretKeyToPublicKey':
        return $2.Secp256k1SecretKeyToPublicKeyRequest();
      case 'Secp256k1Sign':
        return $2.Secp256k1SignRequest();
      case 'Secp256k1Verify':
        return $2.Secp256k1VerifyRequest();
      default:
  ...
  $async.Future<$pb.GeneratedMessage> handleCall(
    ...
    switch (methodName) {
      case 'HmacSha512':
        return this.hmacSha512(ctx, request as $2.HmacSha512Request);
      case 'Ripemd160':
        return this.ripemd160(ctx, request as $2.Ripemd160Request);
      case 'Secp256k1SecretKeyToPublicKey':
        return this.secp256k1SecretKeyToPublicKey(ctx, request as $2.Secp256k1SecretKeyToPublicKeyRequest);
      case 'Secp256k1Sign':
        return this.secp256k1Sign(ctx, request as $2.Secp256k1SignRequest);
      case 'Secp256k1Verify':
        return this.secp256k1Verify(ctx, request as $2.Secp256k1VerifyRequest);
      default:
        throw $core.ArgumentError('Unknown method: $methodName');
    }
  }
