...
extension type WalletServiceClient (connect.Transport _transport) {
  ...
  Future<walletv1wallet.SelectCoinsResponse> selectCoins(
    walletv1wallet.SelectCoinsRequest input, {
    connect.Headers? headers,
    connect.AbortSignal? signal,
    Function(connect.Headers)? onHeader,
    Function(connect.Headers)? onTrailer,
    ...
    return connect.Client(_transport).unary(
      specs.WalletService.selectCoins,
      input,
      signal: signal,
      headers: headers,
      onHeader: onHeader,
  ...
  Future<walletv1wallet.CreateBackupResponse> createBackup(
    ...
    return connect.Client(_transport).unary(
      specs.WalletService.createBackup,
      input,
      signal: signal,
      headers: headers,
      onHeader: onHeader,
  ...
  Future<googleprotobufempty.Empty> restoreBackup(
    ...
    return connect.Client(_transport).unary(
      specs.WalletService.restoreBackup,
      input,
      signal: signal,
      headers: headers,
      onHeader: onHeader,
  ...
  Future<walletv1wallet.ValidateBackupResponse> validateBackup(
    ...
    return connect.Client(_transport).unary(
      specs.WalletService.validateBackup,
      input,
      signal: signal,
      headers: headers,
      onHeader: onHeader,
