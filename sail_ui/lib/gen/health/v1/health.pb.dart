...
class CheckResponse_ServiceStatus extends $pb.GeneratedMessage {
  ...
  factory CheckResponse_ServiceStatus.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory CheckResponse_ServiceStatus.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CheckResponse.ServiceStatus',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'health.v1'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'serviceName')
    ..e<CheckResponse_Status>(2, _omitFieldNames ? '' : 'status', $pb.PbFieldType.OE,
        defaultOrMaker: CheckResponse_Status.STATUS_UNSPECIFIED,
        valueOf: CheckResponse_Status.valueOf,
        enumValues: CheckResponse_Status.values)
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      ...
      'Will be removed in next major version')
  CheckResponse_ServiceStatus copyWith(void Function(CheckResponse_ServiceStatus) updates) =>
      super.copyWith((message) => updates(message as CheckResponse_ServiceStatus)) as CheckResponse_ServiceStatus;
  ...
  @$core.pragma('dart2js:noInline')
  static CheckResponse_ServiceStatus getDefault() =>
      _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<CheckResponse_ServiceStatus>(create);
  ...
  @$pb.TagNumber(2)
  set status(CheckResponse_Status v) {
    setField(2, v);
  }
...
class CheckResponse extends $pb.GeneratedMessage {
  ...
  factory CheckResponse.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory CheckResponse.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CheckResponse',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'health.v1'), createEmptyInstance: create)
    ..pc<CheckResponse_ServiceStatus>(1, _omitFieldNames ? '' : 'serviceStatuses', $pb.PbFieldType.PM,
        subBuilder: CheckResponse_ServiceStatus.create)
    ..hasRequiredFields = false;
  ...
  CheckResponse copyWith(void Function(CheckResponse) updates) =>
      super.copyWith((message) => updates(message as CheckResponse)) as CheckResponse;
