...
func (c *Client) CreateRawTransactionAsync(ctx context.Context, inputs []btcjson.TransactionInput,
	amounts map[btcutil.Address]btcutil.Amount, lockTime *int64,
...
func (c *Client) SignRawTransactionWithWallet3Async(ctx context.Context, tx *wire.MsgTx,
	inputs []btcjson.RawTxWitnessInput, hashType SigHashType,
) FutureSignRawTransactionWithWalletResult {
	txHex := ""
	if tx != nil {
		// Serialize the transaction and convert to hex string.
...
func (c *Client) TestMempoolAcceptAsync(ctx context.Context, txns []*wire.MsgTx,
	...
	zerolog.Ctx(ctx).Debug().Msgf("TestMempoolAcceptAsync: backend version %s", version)
...
func (c *Client) GetTxSpendingPrevOutAsync(ctx context.Context,
	...
	zerolog.Ctx(ctx).Debug().Msgf("GetTxSpendingPrevOutAsync: backend version %s", version)
