...
import 'package:bitassets/viewmodels/bitassets_config_editor_viewmodel.dart';
...
@RoutePage()
class BitassetsConfEditorPage extends StatelessWidget {
  const BitassetsConfEditorPage({super.key});
                ...
                children: [
                  ...
                  Expanded(
                    child: SailText.secondary12(
                      'BitAssets does not read from a config file. These settings are converted to CLI arguments when BitAssets starts. '
                      'Restart BitAssets after saving for changes to take effect.',
                      color: theme.colors.info,
                    ),
                  ),
                ],
        ...
        children: [
          ...
          Expanded(
            child: SelectableText(
              cliArgs.isEmpty ? '(no args)' : 'bitassets ${cliArgs.join(' ')}',
              style: TextStyle(
                fontFamily: 'IBMPlexMono',
                fontSize: 12,
                color: theme.colors.text,
