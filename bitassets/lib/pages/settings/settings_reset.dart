...
class _SettingsResetState extends State<SettingsReset> {
  ...
  Future<void> _performReset() async {
    ...
    setState(() => _status = 'Stopping BitAssets...');
    ...
    if (_deleteBlockchainData) {
      ...
      try {
        ...
        log.i('Successfully deleted BitAssets blockchain data');
      } catch (e) {
    ...
    if (_deleteSettings) {
      ...
      try {
        ...
        log.i('Successfully deleted BitAssets settings');
      } catch (e) {
    ...
    if (_deleteWalletFiles) {
      ...
      try {
        ...
        log.i('Successfully deleted BitAssets wallet files');
      } catch (e) {
        log.e('Could not delete wallet files: $e');
      }
    }

    setState(() => _status = 'Restarting BitAssets...');
    bootBinaries(log);
