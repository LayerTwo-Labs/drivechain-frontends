/// Configuration model for the BitAssets sidechain.
...
class BitassetsConfig {
  Map<String, String> settings = {};

  BitassetsConfig();

  BitassetsConfig.fromConfig(BitassetsConfig other) {
  ...
  String serialize() {
    ...
    buffer.writeln('# BitAssets Configuration - Generated by BitAssets App');
    buffer.writeln('# These settings are converted to CLI arguments when BitAssets starts.');
    buffer.writeln();
  ...
  bool operator ==(Object other) {
    ...
    if (other is! BitassetsConfig) return false;
