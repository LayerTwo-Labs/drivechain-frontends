...
void main() {
  ...
  setUpAll(() async {
    ...
    final inquisitionRPC = MockInquisitionRPC();
    ...
    if (!GetIt.I.isRegistered<InquisitionRPC>()) {
      GetIt.I.registerLazySingleton<InquisitionRPC>(() => inquisitionRPC);
    }
  ...
  group('UI Component Tests', () {
    testWidgets('SailCard renders with title and content', (tester) async {
      await tester.pumpSailPage(
        SailCard(
          title: 'Inquisition Card',
          subtitle: 'Test Subtitle',
          child: SailText.primary15('Card Content'),
        ),
      );

      expect(find.text('Inquisition Card'), findsOneWidget);
