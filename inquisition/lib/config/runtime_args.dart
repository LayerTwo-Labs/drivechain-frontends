...
abstract class RuntimeArgs {
  ...
  static Future<Directory> datadir() async {
    final fromEnv = Platform.environment['INQUISITION_DATADIR'] ?? const String.fromEnvironment('INQUISITION_DATADIR');
  ...
  static bool consoleLog = Platform.environment['INQUISITION_LOG_CONSOLE']?.isNotEmpty ?? false;

  static bool fileLog = Platform.environment['INQUISITION_LOG_FILE']?.isNotEmpty ?? false;

  static final String _network =
      Platform.environment['INQUISITION_NETWORK'] ?? const String.fromEnvironment('INQUISITION_NETWORK');
