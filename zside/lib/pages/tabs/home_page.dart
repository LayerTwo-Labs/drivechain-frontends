  ...
  List<CommandItem> _getMenuCommands(BuildContext dialogContext) {
    ...
    return [
      ...
      CommandItem(
        ...
        category: 'Your Wallet',
        onSelected: () async {
          await router.push(BackupWalletRoute(appName: 'zside'));
        },
      ),
      CommandItem(
      ...
      CommandItem(
        ...
        category: 'Navigation',
        onSelected: () {
          AutoRouterX(context).tabsRouter.setActiveIndex(Tabs.ZSideHomepage.index);
          Navigator.of(dialogContext).pop();
        },
      ),
      CommandItem(
        ...
        category: 'Navigation',
        onSelected: () {
          AutoRouterX(context).tabsRouter.setActiveIndex(Tabs.ZSideShieldDeshield.index);
          Navigator.of(dialogContext).pop();
        },
      ),
      CommandItem(
        ...
        category: 'Navigation',
        onSelected: () {
          AutoRouterX(context).tabsRouter.setActiveIndex(Tabs.ZSideMeltCast.index);
          Navigator.of(dialogContext).pop();
        },
      ),
      CommandItem(
      ...
      CommandItem(
        ...
        category: 'Navigation',
        onSelected: () async {
          await router.push(ZSideConfigureHomepageRoute());
        },
      ),
