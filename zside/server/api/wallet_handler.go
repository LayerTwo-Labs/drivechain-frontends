...
import (
	...
	pb "github.com/LayerTwo-Labs/sidesail/zside/server/gen/walletmanager/v1"
	svc "github.com/LayerTwo-Labs/sidesail/zside/server/gen/walletmanager/v1/walletmanagerv1connect"
...
func (h *WalletHandler) GenerateWallet(_ context.Context, req *connect.Request[pb.GenerateWalletRequest]) (*connect.Response[pb.GenerateWalletResponse], error) {
	...
	// Default sidechain slots for ZSide
